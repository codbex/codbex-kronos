...
1. Usage with `pack`:
    ...
    ```
    pack build --builder ghcr.io/codbex/kronos-buildpacks-builder-kyma-runtime <my-org>/<my-repository>
    ```
...
1. Create Image:
    ...
    spec:
      ...
      source:
        blob:
          url: https://github.com/coodbex/codbex-kronos/raw/main/samples/xsjs-simple.zip
    ```
