...
/**
 * The Class CSVRecordMetadata.
 */
public class CSVRecordMetadata {
  ...
  /**
   * Instantiates a new CSV record metadata.
   *
   ...
   */
  public CSVRecordMetadata(CSVRecord csvRecord, PersistenceTableModel tableMetadataModel, List<String> headerNames,
