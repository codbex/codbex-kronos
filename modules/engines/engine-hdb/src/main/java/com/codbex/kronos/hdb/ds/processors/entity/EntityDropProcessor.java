 ...
 */
public class EntityDropProcessor extends AbstractProcessor<DataStructureEntityModel> {

  private static final Logger logger = LoggerFactory.getLogger(EntityDropProcessor.class);
