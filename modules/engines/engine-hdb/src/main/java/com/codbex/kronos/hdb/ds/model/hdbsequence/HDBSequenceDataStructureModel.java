...
public class HDBSequenceDataStructureModel extends DataStructureModel {
  ...
  public HDBSequenceDataStructureModel(){}

  public HDBSequenceDataStructureModel(HDBSequenceModel model){
