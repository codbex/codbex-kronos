...
import com.codbex.kronos.hdb.ds.processors.synonym.SynonymCreateProcessor;
import com.codbex.kronos.hdb.ds.processors.synonym.SynonymDropProcessor;
 ...
 */
public class HDBSynonymManagerService extends AbstractDataStructureManagerService<DataStructureHDBSynonymModel> {

  /**
   * The Constant logger.
   */
  private static final Logger logger = LoggerFactory.getLogger(HDBSynonymManagerService.class);
   ...
   */
  private IHDBProcessor synonymCreateProcessor = new SynonymCreateProcessor();

  /**
   * The synonym drop processor.
   */
  private IHDBProcessor synonymDropProcessor = new SynonymDropProcessor();
  ...
  public String getDataStructureType() {
    return IDataStructureModel.FILE_EXTENSION_HDB_SYNONYM;
  }
