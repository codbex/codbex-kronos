 ...
 */
public class FunctionDropProcessor extends AbstractHDBProcessor<DataStructureHDBTableFunctionModel> {

  /**
   * The Constant logger.
   */
  private static final Logger logger = LoggerFactory.getLogger(FunctionDropProcessor.class);
  ...
  public boolean execute(Connection connection, DataStructureHDBTableFunctionModel functionModel)
    ...
    if (SqlFactory.getNative(connection)
      ...
      if (!(dialect.getClass().equals(HanaSqlDialect.class))) {
        ...
        applyArtefactState(functionModel.getName(), functionModel.getLocation(), functionArtefact, ArtefactState.FAILED_DELETE,
            errorMessage);
        ...
        try {
          ...
          applyArtefactState(functionModel.getName(), functionModel.getLocation(), functionArtefact, ArtefactState.SUCCESSFUL_DELETE,
              message);
          return true;
