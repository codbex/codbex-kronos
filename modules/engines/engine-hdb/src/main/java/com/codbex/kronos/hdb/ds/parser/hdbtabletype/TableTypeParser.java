...
import com.codbex.kronos.hdb.ds.model.hdbtabletype.HDBTableTypePrimaryKeyDataStructureModel;
...
public class TableTypeParser implements DataStructureParser<HDBTableTypeDataStructureModel> {
  ...
  private static final Logger logger = LoggerFactory.getLogger(TableTypeParser.class);
  ...
  @Override
  public HDBTableTypeDataStructureModel parse(DataStructureParametersModel parametersModel)
  ...
  private HDBTableTypeDataStructureModel parseHanaXSClassicContent(String location, String content)
    ...
    HDBTableTypeDataStructureModel dataStructureHDBTableTypeModel = new HDBTableTypeDataStructureModel();

    HDBUtils.populateDataStructureModel(location, content, dataStructureHDBTableTypeModel, HDBDataStructureModel.TYPE_HDB_TABLE_TYPE,
    ...
    HDBTableTypePrimaryKeyDataStructureModel primaryKey = new HDBTableTypePrimaryKeyDataStructureModel();
  ...
  private HDBTableTypeDataStructureModel parseHanaXSAdvancedContent(String location, String content) {
  ...
  public String getType() {
    return HDBDataStructureModel.TYPE_HDB_TABLE_TYPE;
  }

  @Override
  public Class<HDBTableTypeDataStructureModel> getDataStructureClass() {
    return HDBTableTypeDataStructureModel.class;
  }
}
