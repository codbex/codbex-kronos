 ...
 */
public class HDBTableColumnDataStructureModel {
   ...
   */
  public HDBTableColumnDataStructureModel() {
   ...
   */
  public HDBTableColumnDataStructureModel(String name, String type, String length, boolean nullable, boolean primaryKey,
