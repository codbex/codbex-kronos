...
public class EntityUpdateProcessor extends AbstractProcessor<DataStructureEntityModel> {

  private static final Logger logger = LoggerFactory.getLogger(EntityUpdateProcessor.class);

  private IHDBProcessor<DataStructureEntityModel> entityDropProcessor = new EntityDropProcessor();
  private IHDBProcessor<DataStructureEntityModel> entityCreateProcessor = new EntityCreateProcessor();
