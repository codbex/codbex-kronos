...
public class HDBSchemaDropProcessor extends AbstractProcessor<HDBSchemaDataStructureModel> {
  ...
  public boolean execute(Connection connection, HDBSchemaDataStructureModel hdbSchema)
      throws SQLException {
