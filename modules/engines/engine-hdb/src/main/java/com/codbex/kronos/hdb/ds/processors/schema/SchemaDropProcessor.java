 ...
 */
public class SchemaDropProcessor extends AbstractHDBProcessor<DataStructureHDBSchemaModel> {
   ...
   */
  public boolean execute(Connection connection, DataStructureHDBSchemaModel schemaModel)
      throws SQLException {
