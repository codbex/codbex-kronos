 ...
 */
public class EntityAlterProcessor {

  private static final Logger logger = LoggerFactory.getLogger(EntityAlterProcessor.class);
...
//			String typeName = nativeDialect.getDataTypeName(DataTypeUtils.getDatabaseType(rsColumns.getInt(5)));
    ...
    // ADD iteration
    for (HDBTableColumnDataStructureModel columnModel : entityModel.getColumns()) {
