 ...
 */
public class ContextDataStructureModel {

  private String name;

  private Map<String, TypeDefinitionDataStructureModel> types = new HashMap<String, TypeDefinitionDataStructureModel>();
   ...
   * @return the types
   */
  public Map<String, TypeDefinitionDataStructureModel> getTypes() {
    return types;
  }
