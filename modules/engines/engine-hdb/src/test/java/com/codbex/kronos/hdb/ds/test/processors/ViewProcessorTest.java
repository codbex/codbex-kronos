...
public class ViewProcessorTest extends AbstractDirigibleTest {
	...
	public void executeCreateViewHANAv1Successfully() throws Exception {
		...
		String sample = IOUtils.toString(ViewParserTest.class.getResourceAsStream("/ItemsByOrderHANAv1.hdbview"), StandardCharsets.UTF_8);

		HDBViewDataStructureModel model = DataStructureModelFactory.parseView("hdb_view.db.a1/path/ItemsByOrderHANAv1.hdbview", sample);
	...
	public void executeCreateViewHANAv2Successfully() throws Exception {
		ViewCreateProcessor processorSpy = spy(ViewCreateProcessor.class);
		String sample = IOUtils.toString(ViewParserTest.class.getResourceAsStream("/ItemsByOrderHANAv2.hdbview"), StandardCharsets.UTF_8);

		HDBViewDataStructureModel model = DataStructureModelFactory.parseView("hdb_view.db/ItemsByOrderHANAv2.hdbview", sample);
	...
	public void executeDropViewSuccessfully() throws Exception {
		...
		HDBViewDataStructureModel model = DataStructureModelFactory.parseView("hdb_view/ItemsByOrderHANAv1.hdbview", sample);
