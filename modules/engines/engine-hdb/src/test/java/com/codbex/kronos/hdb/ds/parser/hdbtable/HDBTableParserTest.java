...
public class HDBTableParserTest extends AbstractDirigibleTest {

    @Test
    public void parseTable() throws Exception {
        InputStream in = HDBTableParserTest.class.getResourceAsStream("/Sports.hdbtable");
    ...
    public void failIfParsingRepetitiveProperties() throws Exception {
      InputStream in = HDBTableParserTest.class.getResourceAsStream("/DuplicateTableProperties.hdbtable");
    ...
    public void failIfParsingMissingMandatoryProperties() throws Exception {
      InputStream in = HDBTableParserTest.class.getResourceAsStream("/MissingMandatoryTableProperties.hdbtable");
      String content = IOUtils.toString(in, StandardCharsets.UTF_8);
      DataStructureParametersModel parametersModel =
    ...
    public void parseRowTableWithIndexes() throws Exception {
      InputStream in = HDBTableParserTest.class.getResourceAsStream("/ParsingTableWithUniqueAndNoUniqueIndexes.hdbtable");
      String contents = IOUtils.toString(in, StandardCharsets.UTF_8);
    ...
    private static void assertEmptyOrNoIndexesTable(String hdbTablePath) throws IOException, DataStructuresException, ArtifactParserException {
      InputStream in = HDBTableParserTest.class.getResourceAsStream(hdbTablePath);
      String contents = IOUtils.toString(in, StandardCharsets.UTF_8);
