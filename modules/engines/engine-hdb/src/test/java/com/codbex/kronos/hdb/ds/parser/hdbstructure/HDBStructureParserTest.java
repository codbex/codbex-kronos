...
public class HDBStructureParserTest extends AbstractDirigibleTest {

  @Test
  public void testParseWhenStructureDefinitionIsCorrectTest() throws Exception {
    InputStream in = HDBStructureParserTest.class.getResourceAsStream("/ParsingHDBStructure.hdbstructure");
  ...
  public void testParseWhenStructurePKIsWrongShouldThrowException()
    ...
    HDBStructureParser parser = new HDBStructureParser();
