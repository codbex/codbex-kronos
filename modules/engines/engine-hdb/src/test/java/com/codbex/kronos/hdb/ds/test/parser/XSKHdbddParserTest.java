...
public class XSKHdbddParserTest extends AbstractDirigibleTest {
  ...
  public void testParseHanaXSClassicContentWithSyntaxErrorFail() {
    XSKDataStructuresException exception = assertThrows(
        ...
        () -> XSKDataStructureModelFactory.parseHdbdd("acme/ITC_EXPIRED_CONFIG.hdbdd", "")
    );
    assertEquals(
        "Failed to parse file: acme/ITC_EXPIRED_CONFIG.hdbdd. Error at line: 6  - Before an entity element declaration only the 'key' keyword is allowed",
  ...
  public void testParseHanaXSClassicContentWithLexerErrorFail() {
    XSKDataStructuresException exception = assertThrows(
        XSKDataStructuresException.class,
        () -> XSKDataStructureModelFactory.parseHdbdd("acme/ITC_EXPIRED_CONFIG1.hdbdd", "")
    );
    assertEquals(
        "Wrong format of HDB HDBDD: [acme/ITC_EXPIRED_CONFIG1.hdbdd] during parsing. Ensure you are using the correct format for the correct compatibility version.",
        exception.getMessage());
  }

  @Test
  public void testParseHDBDDWithManagedAss() throws Exception {
    XSKDataStructureModel parsedModel = XSKDataStructureModelFactory.parseHdbdd("acme/ProductsWithManagedAss.hdbdd", "");
    ...
    assertEquals("acme::ProductsWithManagedAss.Orders", orderDataStructure.getName());
    ...
    assertEquals("PK_acme::ProductsWithManagedAss.Orders", orderDataStructure.getConstraints().getPrimaryKey().getName());
    ...
    assertEquals("acme::ProductsWithManagedAss.Country", orderDataStructure.getConstraints().getForeignKeys().get(0).getReferencedTable());
    assertEquals("acme::ProductsWithManagedAss.Orders.Country", orderDataStructure.getConstraints().getForeignKeys().get(0).getName());
    ...
    assertEquals("acme::ProductsWithManagedAss.City", orderDataStructure.getConstraints().getForeignKeys().get(1).getReferencedTable());
    assertEquals("acme::ProductsWithManagedAss.Orders.City", orderDataStructure.getConstraints().getForeignKeys().get(1).getName());
    ...
    assertEquals("acme::ProductsWithManagedAss.Country", countryDataStructure.getName());
    ...
    assertEquals("PK_acme::ProductsWithManagedAss.Country", countryDataStructure.getConstraints().getPrimaryKey().getName());
    ...
    assertEquals("acme/ProductsWithManagedAss.hdbdd", parsedModel.getLocation());
    assertEquals("acme/ProductsWithManagedAss.hdbdd", parsedModel.getName());
  ...
  public void testParseHDBDDWithManagedAssAndAlias() throws Exception {
    XSKDataStructureModel parsedModel = XSKDataStructureModelFactory.parseHdbdd("acme/ClientsWithManagedAssAndAlias.hdbdd", "");
    ...
    assertEquals("acme::ClientsWithManagedAssAndAlias.Person", personDataStructure.getName());
    ...
    assertEquals("PK_acme::ClientsWithManagedAssAndAlias.Person", personDataStructure.getConstraints().getPrimaryKey().getName());
    ...
    assertEquals("acme::ClientsWithManagedAssAndAlias.Address",
    ...
    assertEquals("acme::ClientsWithManagedAssAndAlias.Person.address1",
        personDataStructure.getConstraints().getForeignKeys().get(0).getName());
    assertEquals("acme::ClientsWithManagedAssAndAlias.Person.address2",
    ...
    assertEquals("acme::ClientsWithManagedAssAndAlias.Address", addressDataStructure.getName());
    ...
    assertEquals("PK_acme::ClientsWithManagedAssAndAlias.Address", addressDataStructure.getConstraints().getPrimaryKey().getName());
    ...
    assertEquals("acme/ClientsWithManagedAssAndAlias.hdbdd", parsedModel.getLocation());
    assertEquals("acme/ClientsWithManagedAssAndAlias.hdbdd", parsedModel.getName());
    assertEquals("HDBDD", parsedModel.getType());
    assertEquals("guest", parsedModel.getCreatedBy());
    assertEquals(0, parsedModel.getDependencies().size());
    assertEquals("ADMIN", parsedModel.getSchema());
  ...
  public void testParseHDBDDWithUnManagedAss() throws Exception {
    XSKDataStructureModel parsedModel = XSKDataStructureModelFactory.parseHdbdd("acme/ProductsWithUnManagedAss.hdbdd", "");

    assertEquals(2, ((XSKDataStructureCdsModel) parsedModel).getTableModels().size());

    XSKDataStructureHDBTableModel orderDataStructure = ((XSKDataStructureCdsModel) parsedModel).getTableModels().get(0);
    assertEquals("acme::ProductsWithUnManagedAss.Orders", orderDataStructure.getName());
    assertEquals("ADMIN", orderDataStructure.getSchema());
    assertEquals(XSKDBContentType.XS_CLASSIC, orderDataStructure.getDBContentType());
    assertNotNull(orderDataStructure.getConstraints().getPrimaryKey());
    assertEquals(1, orderDataStructure.getConstraints().getPrimaryKey().getColumns().length);
    assertEquals("Id", orderDataStructure.getConstraints().getPrimaryKey().getColumns()[0]);
    assertEquals("PK_acme::ProductsWithUnManagedAss.Orders", orderDataStructure.getConstraints().getPrimaryKey().getName());
    assertNull(orderDataStructure.getConstraints().getPrimaryKey().getModifiers());
    ...
    assertEquals("acme::ProductsWithUnManagedAss.Item", itemDataStructure.getName());
    ...
    assertEquals("PK_acme::ProductsWithUnManagedAss.Item", itemDataStructure.getConstraints().getPrimaryKey().getName());
    ...
    assertEquals("acme::ProductsWithUnManagedAss.Orders", itemDataStructure.getConstraints().getForeignKeys().get(0).getReferencedTable());
    assertEquals("acme::ProductsWithUnManagedAss.Item.OrderId", itemDataStructure.getConstraints().getForeignKeys().get(0).getName());
    ...
    assertEquals("acme/ProductsWithUnManagedAss.hdbdd", parsedModel.getLocation());
    assertEquals("acme/ProductsWithUnManagedAss.hdbdd", parsedModel.getName());
    assertEquals("HDBDD", parsedModel.getType());
    assertEquals("guest", parsedModel.getCreatedBy());
    assertEquals(0, parsedModel.getDependencies().size());
    assertEquals("ADMIN", parsedModel.getSchema());
  ...
  public void testParseHDBDDWithNoKeyAnnotation() throws Exception {
    XSKDataStructuresException exception = assertThrows(
        XSKDataStructuresException.class,
        () -> XSKDataStructureModelFactory.parseHdbdd("acme/NoKeyAnnSample.hdbdd", "")
    );
    assertEquals(
        "Failed to parse file: acme/NoKeyAnnSample.hdbdd. Error at line: 10 col: 1. Annotation nokey has been specified for entity with keys.",
        exception.getMessage());
  }

  @Test
  public void testParseHDBDDWithGenerateTableTypeAnnotation() throws Exception {
    XSKDataStructureModel parsedModel = XSKDataStructureModelFactory.parseHdbdd("acme/GenerateTableTypeAnnotationSample.hdbdd", "");
    ...
    assertEquals("acme::GenerateTableTypeAnnotationSample.MyNestedStruct", tableTypeModel.getName());
  ...
  public void testParseHDBDDWithDateTimeFunctionDefaultValue() throws Exception {
    XSKDataStructureModel parsedModel = XSKDataStructureModelFactory.parseHdbdd("acme/DefaultValueWithDateTimeFunction.hdbdd", "");
    ...
    assertEquals("acme::DefaultValueWithDateTimeFunction.Orders", tableModel.getName());
  ...
  public void testParseHDBDDWithTableTypeAnnotationColumn() throws Exception {
    XSKDataStructureModel parsedModel = XSKDataStructureModelFactory.parseHdbdd("acme/TableTypeColumn.hdbdd", "");
  ...
  public void testParseHDBDDWithTableTypeAnnotationRow() throws Exception {
    XSKDataStructureModel parsedModel = XSKDataStructureModelFactory.parseHdbdd("acme/TableTypeRow.hdbdd", "");
  ...
  public void testParseHDBDDWithNoTableTypeAnnotation() throws Exception {
    XSKDataStructureModel parsedModel = XSKDataStructureModelFactory.parseHdbdd("acme/NoTableType.hdbdd", "");
  ...
  public void testParseHDBDDWithViewDefinitionSimple() throws Exception {
    ...
    XSKDataStructureModel parsedModel = XSKDataStructureModelFactory.parseHdbdd("acme/ViewDefinitionSimple.hdbdd", "");
  ...
  public void testParseHDBDDWithViewDefinitionWithJoin() throws Exception {
    ...
    XSKDataStructureModel parsedModel = XSKDataStructureModelFactory.parseHdbdd("acme/ViewDefinitionWithJoin.hdbdd", "");
    XSKDataStructureHDBViewModel viewModel = ((XSKDataStructureCdsModel) parsedModel).getViewModels().get(0);
  ...
  public void testParseHDBDDWithViewDefinitionWithWhere() throws Exception {
    ...
    XSKDataStructureModel parsedModel = XSKDataStructureModelFactory.parseHdbdd("acme/ViewDefinitionWithWhere.hdbdd", "");
    XSKDataStructureHDBViewModel viewModel = ((XSKDataStructureCdsModel) parsedModel).getViewModels().get(0);
  ...
  public void testParseHDBDDWithViewDefinitionWithUnion() throws Exception {
    ...
    XSKDataStructureModel parsedModel = XSKDataStructureModelFactory.parseHdbdd("acme/ViewDefinitionWithUnion.hdbdd", "");
    XSKDataStructureHDBViewModel viewModel = ((XSKDataStructureCdsModel) parsedModel).getViewModels().get(0);
