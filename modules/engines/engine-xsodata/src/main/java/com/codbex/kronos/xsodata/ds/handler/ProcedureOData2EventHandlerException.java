 ...
 */
public class ProcedureOData2EventHandlerException extends RuntimeException {
   ...
   */
  public ProcedureOData2EventHandlerException(String message, Throwable cause) {
    super(message, cause);
  }
   ...
   * @param cause the cause
   */
  public ProcedureOData2EventHandlerException(Throwable cause) {
    super(cause);
  }
