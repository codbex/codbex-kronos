...
import com.codbex.kronos.xsodata.ds.api.IXSKODataModel;
import com.codbex.kronos.xsodata.ds.api.XSKODataException;
import com.codbex.kronos.xsodata.ds.model.XSKODataModel;
import com.codbex.kronos.xsodata.ds.service.XSKOData2ODataHTransformer;
import com.codbex.kronos.xsodata.ds.service.XSKOData2ODataMTransformer;
import com.codbex.kronos.xsodata.ds.service.XSKOData2ODataXTransformer;
import com.codbex.kronos.xsodata.ds.service.XSKODataCoreService;
import com.codbex.kronos.xsodata.ds.service.XSKTableMetadataProvider;
import com.codbex.kronos.xsodata.utils.XSKODataUtils;
...
public class XSKODataSynchronizer extends AbstractSynchronizer implements IOrderedSynchronizerContribution {
      ...
      if (beforeSynchronizing()) {
        ...
        try {
          if (isSynchronizerSuccessful("org.eclipse.dirigible.database.ds.synchronizer.DataStructuresSynchronizer")
              && isSynchronizerSuccessful("com.codbex.kronos.hdb.ds.synchronizer.XSKDataStructuresSynchronizer")) {
            ...
            failedSynchronization(SYNCHRONIZER_NAME,
                "Skipped due to dependencies: org.eclipse.dirigible.database.ds.synchronizer.DataStructuresSynchronizer, "
                    + "com.codbex.kronos.hdb.ds.synchronizer.XSKDataStructuresSynchronizer");
          }
        } catch (Exception e) {
  ...
  /*
   * (non-Javadoc)
   * @see org.eclipse.dirigible.core.scheduler.api.AbstractSynchronizer#synchronizeResource(com.codbex.kronos.hdb.ds.parser.XSKDataStructureParser
