...
public class KronosOData2ODataXTransformer {

    private OData2ODataXTransformer oData2ODataXTransformer = new OData2ODataXTransformer(new TableMetadataProvider(), new XSODataPropertyNameEscaper());
