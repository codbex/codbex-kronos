...
public class KronosOData2EventHandlerTest {
  ...
  @Test
  public void testBeforeCreateEntity() throws Exception {
    // procedure
    mockGetHandlers();
  ...
  @Test
  public void testAfterCreateEntity() throws Exception {
    // procedure
    mockGetHandlers();
    mockTemporaryTables(spyProcedureHandler);
    mockCallProcedure(spyProcedureHandler, false);
  ...
  @Test
  public void testOnCreateEntity() throws Exception {
    // procedure
    mockGetHandlers();
    mockTemporaryTables(spyProcedureHandler);
    mockCallProcedure(spyProcedureHandler, false);
  ...
  @Test
  public void testBeforeUpdateEntity() throws Exception {
    // procedure
    mockGetHandlers();
    mockTemporaryTables(spyProcedureHandler);
  ...
  @Test
  public void testAfterUpdateEntity() throws Exception {
    // procedure
    mockGetHandlers();
    mockTemporaryTables(spyProcedureHandler);
    mockCallProcedure(spyProcedureHandler, true);
  ...
  @Test
  public void testOnUpdateEntity() throws Exception {
    // procedure
    mockGetHandlers();
    mockTemporaryTables(spyProcedureHandler);
    mockCallProcedure(spyProcedureHandler, true);
  ...
  @Test
  public void testBeforeDeleteEntity() throws Exception {
    // procedure
    mockGetHandlers();
    mockTemporaryTables(spyProcedureHandler);
    mockCallProcedure(spyProcedureHandler, false);
  ...
  @Test
  public void testAfterDeleteEntity() throws Exception {
    // procedure
    mockGetHandlers();
    mockTemporaryTables(spyProcedureHandler);
    mockCallProcedure(spyProcedureHandler, false);
  ...
  @Test
  public void testOnDeleteEntity() throws Exception {
    // procedure
    mockGetHandlers();
    mockTemporaryTables(spyProcedureHandler);
    mockCallProcedure(spyProcedureHandler, false);
  ...
  private void mockGetHandlers() throws Exception {
  ...
  private void mockTemporaryTables(AbstractKronosOData2EventHandler handler) throws Exception {
  ...
  private void mockCallProcedure(KronosProcedureOData2EventHandler handler, boolean isUpdate) throws Exception {
  ...
  private void assertResponse(ODataResponse response) throws Exception {
