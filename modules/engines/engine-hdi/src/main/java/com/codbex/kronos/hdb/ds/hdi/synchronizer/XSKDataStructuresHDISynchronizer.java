...
import com.codbex.kronos.hdb.ds.processors.hdi.XSKHDIContainerCreateProcessor;
import com.codbex.kronos.hdb.ds.processors.hdi.XSKHDIContainerDropProcessor;
import com.codbex.kronos.hdb.ds.service.XSKDataStructuresCoreService;
import com.codbex.kronos.hdb.ds.service.parser.IXSKCoreParserService;
import com.codbex.kronos.hdb.ds.service.parser.XSKCoreParserService;
...
public class XSKDataStructuresHDISynchronizer extends AbstractSynchronizer implements IOrderedSynchronizerContribution {
      ...
      if (beforeSynchronizing()) {
        ...
        try {
          if (isSynchronizerSuccessful("org.eclipse.dirigible.database.ds.synchronizer.DataStructuresSynchronizer")
              ...
              && isSynchronizerSuccessful("com.codbex.kronos.hdbti.synchronizer.XSKTableImportSynchronizer")) {
            ...
            failedSynchronization(SYNCHRONIZER_NAME,
                "Skipped due to dependencies: org.eclipse.dirigible.database.ds.synchronizer.DataStructuresSynchronizer, "
                    ...
                    + "com.codbex.kronos.hdbti.synchronizer.XSKTableImportSynchronizer");
          }
        } catch (Exception e) {
   ...
   *
   * @see org.eclipse.dirigible.core.scheduler.api.AbstractSynchronizer#
   * synchronizeResource(com.codbex.kronos.hdb.ds.parser.XSKDataStructureParser
