...
/**
 * The listener interface for receiving HDBViewError events.
 * The class that is interested in processing a HDBViewError
 * event implements this interface, and the object created
 * with that class is registered with a component using the
 * component's <code>addHDBViewErrorListener</code> method. When
 * the HDBViewError event occurs, that object's appropriate
 * method is invoked.
 *
 */
