...
public class HDBSequenceParser extends Parser {
    ...
    public static final int T__0 = 1, T__1 = 2, T__2 = 3, T__3 = 4, T__4 = 5, T__5 = 6, T__6 = 7, T__7 = 8, T__8 = 9, T__9 = 10, T__10 = 11,
            T__11 = 12, STRING = 13, INT = 14, BOOLEAN = 15, TRUE = 16, FALSE = 17, WS = 18, LB = 19, RB = 20, EQ = 21, SC = 22,
            SIGNED_INT = 23, LINE_COMMENT = 24, COMMENT = 25;
    public static final int RULE_hdbSequenceDefinition = 0, RULE_property = 1, RULE_schema = 2, RULE_incrementBy = 3, RULE_startWith = 4,
            RULE_maxValue = 5, RULE_noMaxValue = 6, RULE_minValue = 7, RULE_noMinValue = 8, RULE_cycles = 9, RULE_resetBy = 10,
            RULE_publicc = 11, RULE_dependsOnTable = 12, RULE_dependsOnView = 13;

    private static String[] makeRuleNames() {
        return new String[] {"hdbSequenceDefinition", "property", "schema", "incrementBy", "startWith", "maxValue", "noMaxValue",
                "minValue", "noMinValue", "cycles", "resetBy", "publicc", "dependsOnTable", "dependsOnView"};
    }

    public static final String[] ruleNames = makeRuleNames();

    private static String[] makeLiteralNames() {
        return new String[] {null, "'schema'", "'increment_by'", "'start_with'", "'maxvalue'", "'nomaxvalue'", "'minvalue'", "'nominvalue'",
                "'cycles'", "'reset_by'", "'public'", "'depends_on_table'", "'depends_on_view'", null, null, null, "'true'", "'false'",
                null, "'['", "']'", "'='", "';'", "'-'"};
    }
    ...
    private static String[] makeSymbolicNames() {
        return new String[] {null, null, null, null, null, null, null, null, null, null, null, null, null, "STRING", "INT", "BOOLEAN",
                "TRUE", "FALSE", "WS", "LB", "RB", "EQ", "SC", "SIGNED_INT", "LINE_COMMENT", "COMMENT"};
    }
    ...
    public static class HdbSequenceDefinitionContext extends ParserRuleContext {
        ...
        public int getRuleIndex() {
            return RULE_hdbSequenceDefinition;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof HDBSequenceListener)
                ((HDBSequenceListener) listener).enterHdbSequenceDefinition(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof HDBSequenceListener)
                ((HDBSequenceListener) listener).exitHdbSequenceDefinition(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof HDBSequenceVisitor)
                return ((HDBSequenceVisitor<? extends T>) visitor).visitHdbSequenceDefinition(this);
            else
    ...
    public static class PropertyContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof HDBSequenceListener)
                ((HDBSequenceListener) listener).enterProperty(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof HDBSequenceListener)
                ((HDBSequenceListener) listener).exitProperty(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof HDBSequenceVisitor)
                return ((HDBSequenceVisitor<? extends T>) visitor).visitProperty(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class SchemaContext extends ParserRuleContext {
        public TerminalNode EQ() {
            return getToken(HDBSequenceParser.EQ, 0);
        }

        public TerminalNode STRING() {
            return getToken(HDBSequenceParser.STRING, 0);
        }

        public TerminalNode SC() {
            return getToken(HDBSequenceParser.SC, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof HDBSequenceListener)
                ((HDBSequenceListener) listener).enterSchema(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof HDBSequenceListener)
                ((HDBSequenceListener) listener).exitSchema(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof HDBSequenceVisitor)
                return ((HDBSequenceVisitor<? extends T>) visitor).visitSchema(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class IncrementByContext extends ParserRuleContext {
        ...
        public TerminalNode INT() {
            return getToken(HDBSequenceParser.INT, 0);
        }
        ...
        @Override
        public int getRuleIndex() {
            return RULE_incrementBy;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof HDBSequenceListener)
                ((HDBSequenceListener) listener).enterIncrementBy(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof HDBSequenceListener)
                ((HDBSequenceListener) listener).exitIncrementBy(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof HDBSequenceVisitor)
                return ((HDBSequenceVisitor<? extends T>) visitor).visitIncrementBy(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class StartWithContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_startWith;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof HDBSequenceListener)
                ((HDBSequenceListener) listener).enterStartWith(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof HDBSequenceListener)
                ((HDBSequenceListener) listener).exitStartWith(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof HDBSequenceVisitor)
                return ((HDBSequenceVisitor<? extends T>) visitor).visitStartWith(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class MaxValueContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof HDBSequenceListener)
                ((HDBSequenceListener) listener).enterMaxValue(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof HDBSequenceListener)
                ((HDBSequenceListener) listener).exitMaxValue(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof HDBSequenceVisitor)
                return ((HDBSequenceVisitor<? extends T>) visitor).visitMaxValue(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class NoMaxValueContext extends ParserRuleContext {
        ...
        public TerminalNode BOOLEAN() {
            return getToken(HDBSequenceParser.BOOLEAN, 0);
        }
        ...
        @Override
        public int getRuleIndex() {
            return RULE_noMaxValue;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof HDBSequenceListener)
                ((HDBSequenceListener) listener).enterNoMaxValue(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof HDBSequenceListener)
                ((HDBSequenceListener) listener).exitNoMaxValue(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof HDBSequenceVisitor)
                return ((HDBSequenceVisitor<? extends T>) visitor).visitNoMaxValue(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class MinValueContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof HDBSequenceListener)
                ((HDBSequenceListener) listener).enterMinValue(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof HDBSequenceListener)
                ((HDBSequenceListener) listener).exitMinValue(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof HDBSequenceVisitor)
                return ((HDBSequenceVisitor<? extends T>) visitor).visitMinValue(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class NoMinValueContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_noMinValue;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof HDBSequenceListener)
                ((HDBSequenceListener) listener).enterNoMinValue(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof HDBSequenceListener)
                ((HDBSequenceListener) listener).exitNoMinValue(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof HDBSequenceVisitor)
                return ((HDBSequenceVisitor<? extends T>) visitor).visitNoMinValue(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class CyclesContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof HDBSequenceListener)
                ((HDBSequenceListener) listener).enterCycles(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof HDBSequenceListener)
                ((HDBSequenceListener) listener).exitCycles(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof HDBSequenceVisitor)
                return ((HDBSequenceVisitor<? extends T>) visitor).visitCycles(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class ResetByContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof HDBSequenceListener)
                ((HDBSequenceListener) listener).enterResetBy(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof HDBSequenceListener)
                ((HDBSequenceListener) listener).exitResetBy(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof HDBSequenceVisitor)
                return ((HDBSequenceVisitor<? extends T>) visitor).visitResetBy(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class PubliccContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof HDBSequenceListener)
                ((HDBSequenceListener) listener).enterPublicc(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof HDBSequenceListener)
                ((HDBSequenceListener) listener).exitPublicc(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof HDBSequenceVisitor)
                return ((HDBSequenceVisitor<? extends T>) visitor).visitPublicc(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class DependsOnTableContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_dependsOnTable;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof HDBSequenceListener)
                ((HDBSequenceListener) listener).enterDependsOnTable(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof HDBSequenceListener)
                ((HDBSequenceListener) listener).exitDependsOnTable(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof HDBSequenceVisitor)
                return ((HDBSequenceVisitor<? extends T>) visitor).visitDependsOnTable(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class DependsOnViewContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_dependsOnView;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof HDBSequenceListener)
                ((HDBSequenceListener) listener).enterDependsOnView(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof HDBSequenceListener)
                ((HDBSequenceListener) listener).exitDependsOnView(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof HDBSequenceVisitor)
                return ((HDBSequenceVisitor<? extends T>) visitor).visitDependsOnView(this);
            else
                return visitor.visitChildren(this);
        }
    }
