...
public class HDBSequenceModel {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(missingProps, that.missingProps) && Objects.equals(schema, that.schema)
                && Objects.equals(incrementBy, that.incrementBy) && Objects.equals(startWith, that.startWith)
                && Objects.equals(maxValue, that.maxValue) && Objects.equals(noMaxValue, that.noMaxValue)
                && Objects.equals(minValue, that.minValue) && Objects.equals(noMinValue, that.noMinValue)
                && Objects.equals(cycles, that.cycles) && Objects.equals(resetBy, that.resetBy)
                && Objects.equals(dependsOnTable, that.dependsOnTable) && Objects.equals(dependsOnView, that.dependsOnView)
                && Objects.equals(publicProp, that.publicProp);
    }
