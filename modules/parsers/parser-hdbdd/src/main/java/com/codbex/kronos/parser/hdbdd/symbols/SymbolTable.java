...
public class SymbolTable {
  ...
  protected void initTypeSystem() {
    globalBuiltInTypeScope.define(new BuiltInTypeSymbol("String", 1, Arrays.asList(CdsParser.STRING)));
    globalBuiltInTypeScope.define(new BuiltInTypeSymbol("LargeString", Arrays.asList(CdsParser.STRING)));
    globalBuiltInTypeScope.define(new BuiltInTypeSymbol("Binary", 1, Arrays.asList(CdsParser.VARBINARY)));
    globalBuiltInTypeScope.define(new BuiltInTypeSymbol("LargeBinary", Arrays.asList(CdsParser.VARBINARY)));
    globalBuiltInTypeScope.define(new BuiltInTypeSymbol("Integer", Arrays.asList(CdsParser.INTEGER)));
    globalBuiltInTypeScope.define(new BuiltInTypeSymbol("Integer64", Arrays.asList(CdsParser.INTEGER)));
    globalBuiltInTypeScope.define(new BuiltInTypeSymbol("Decimal", 2, Arrays.asList(CdsParser.DECIMAL, CdsParser.INTEGER)));
    globalBuiltInTypeScope.define(new BuiltInTypeSymbol("DecimalFloat", Arrays.asList(CdsParser.DECIMAL)));
    globalBuiltInTypeScope.define(new BuiltInTypeSymbol("BinaryFloat", Arrays.asList(CdsParser.DECIMAL)));
    globalBuiltInTypeScope.define(new BuiltInTypeSymbol("LocalDate", Arrays.asList(CdsParser.LOCAL_DATE, CdsParser.DATETIME_VALUE_FUNCTION)));
    globalBuiltInTypeScope.define(new BuiltInTypeSymbol("LocalTime", Arrays.asList(CdsParser.LOCAL_TIME, CdsParser.DATETIME_VALUE_FUNCTION)));
    globalBuiltInTypeScope.define(new BuiltInTypeSymbol("UTCDateTime", Arrays.asList(CdsParser.UTC_DATE_TIME, CdsParser.DATETIME_VALUE_FUNCTION)));
    globalBuiltInTypeScope.define(new BuiltInTypeSymbol("UTCTimestamp", Arrays.asList(CdsParser.UTC_TIMESTAMP, CdsParser.DATETIME_VALUE_FUNCTION)));
    globalBuiltInTypeScope.define(new BuiltInTypeSymbol("Boolean", Arrays.asList(CdsParser.BOOLEAN)));

    hanaBuiltInTypes.put("ALPHANUM", new BuiltInTypeSymbol("ALPHANUMERIC", 0, Arrays.asList(CdsParser.STRING), true));
    hanaBuiltInTypes.put("SMALLINT", new BuiltInTypeSymbol("SMALLINT", 0, Arrays.asList(CdsParser.INTEGER), true));
    hanaBuiltInTypes.put("TINYINT", new BuiltInTypeSymbol("TINYINT", 0, Arrays.asList(CdsParser.INTEGER), true));
    hanaBuiltInTypes.put("REAL", new BuiltInTypeSymbol("REAL", 0, Arrays.asList(CdsParser.DECIMAL), true));
    hanaBuiltInTypes.put("SMALLDECIMAL", new BuiltInTypeSymbol("SMALLDECIMAL", 0, Arrays.asList(CdsParser.DECIMAL), true));
    hanaBuiltInTypes.put("VARCHAR", new BuiltInTypeSymbol("NVARCHAR", 1, Arrays.asList(CdsParser.STRING), true));
    hanaBuiltInTypes.put("CLOB", new BuiltInTypeSymbol("CLOB", 0, Arrays.asList(CdsParser.VARBINARY), true));
    hanaBuiltInTypes.put("BINARY", new BuiltInTypeSymbol("BINARY", 0, Arrays.asList(CdsParser.VARBINARY), true));
    hanaBuiltInTypes.put("ST_POINT", new BuiltInTypeSymbol("ST_POINT", 0, Arrays.asList(CdsParser.STRING), true));
    hanaBuiltInTypes.put("ST_GEOMETRY", new BuiltInTypeSymbol("ST_GEOMETRY", 0, Arrays.asList(CdsParser.STRING), true));
