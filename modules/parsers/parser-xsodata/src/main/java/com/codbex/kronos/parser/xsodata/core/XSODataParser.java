...
public class XSODataParser extends Parser {
    ...
    public static final int T__0 = 1, T__1 = 2, T__2 = 3, T__3 = 4, T__4 = 5, T__5 = 6, T__6 = 7, T__7 = 8, T__8 = 9, T__9 = 10, T__10 = 11,
            T__11 = 12, T__12 = 13, T__13 = 14, T__14 = 15, T__15 = 16, T__16 = 17, T__17 = 18, T__18 = 19, T__19 = 20, T__20 = 21,
            T__21 = 22, T__22 = 23, T__23 = 24, T__24 = 25, T__25 = 26, T__26 = 27, T__27 = 28, T__28 = 29, T__29 = 30, T__30 = 31,
            T__31 = 32, T__32 = 33, T__33 = 34, T__34 = 35, T__35 = 36, T__36 = 37, T__37 = 38, T__38 = 39, T__39 = 40, T__40 = 41,
            T__41 = 42, T__42 = 43, T__43 = 44, T__44 = 45, T__45 = 46, T__46 = 47, T__47 = 48, T__48 = 49, T__49 = 50, T__50 = 51,
            T__51 = 52, T__52 = 53, T__53 = 54, T__54 = 55, T__55 = 56, T__56 = 57, T__57 = 58, T__58 = 59, T__59 = 60, T__60 = 61,
            T__61 = 62, T__62 = 63, T__63 = 64, T__64 = 65, T__65 = 66, T__66 = 67, SEMICOLON = 68, EQ = 69, QUATED_STRING = 70, COMMA = 71,
            COLON = 72, ESC = 73, WS = 74, LINE_COMMENT = 75, COMMENT = 76, INT = 77;
    public static final int RULE_xsOdataDefinition = 0, RULE_service = 1, RULE_namespace = 2, RULE_body = 3, RULE_content = 4,
            RULE_entry = 5, RULE_entity = 6, RULE_object = 7, RULE_catalogobjectschema = 8, RULE_catalogobjectname = 9, RULE_entityset = 10,
            RULE_entitysetname = 11, RULE_with = 12, RULE_withProp = 13, RULE_withoutProp = 14, RULE_propertylist = 15,
            RULE_columnname = 16, RULE_keys = 17, RULE_keylist = 18, RULE_keygenerated = 19, RULE_concurrencytoken = 20,
            RULE_navigates = 21, RULE_navlist = 22, RULE_naventry = 23, RULE_assocname = 24, RULE_navpropname = 25, RULE_fromend = 26,
            RULE_principal = 27, RULE_dependent = 28, RULE_aggregates = 29, RULE_aggregatestuple = 30, RULE_aggregate = 31,
            RULE_aggregatefunction = 32, RULE_parameters = 33, RULE_parameterskeyand = 34, RULE_parameterentitysetname = 35,
            RULE_parametersresultsprop = 36, RULE_modificationBody = 37, RULE_modification = 38, RULE_create = 39, RULE_update = 40,
            RULE_delete = 41, RULE_modificationspec = 42, RULE_modificationaction = 43, RULE_forbidden = 44, RULE_action = 45,
            RULE_events = 46, RULE_eventlist = 47, RULE_eventlistElement = 48, RULE_eventtype = 49, RULE_association = 50,
            RULE_associationdef = 51, RULE_assocrefconstraint = 52, RULE_principalend = 53, RULE_dependentend = 54, RULE_end = 55,
            RULE_endref = 56, RULE_endtype = 57, RULE_joinpropertieslist = 58, RULE_multiplicity = 59, RULE_multiplicityvalue = 60,
            RULE_assoctable = 61, RULE_repoobject = 62, RULE_overprincipalend = 63, RULE_overdependentend = 64, RULE_overend = 65,
            RULE_storage = 66, RULE_nostorage = 67, RULE_storageend = 68, RULE_annotations = 69, RULE_annotationsbody = 70,
            RULE_annotationconfig = 71, RULE_settings = 72, RULE_settingsbody = 73, RULE_settingselement = 74, RULE_supportnull = 75,
            RULE_contentcashecontrol = 76, RULE_metadatacashecontrol = 77, RULE_hints = 78, RULE_hintlist = 79, RULE_hintvalue = 80,
            RULE_nullvalue = 81, RULE_limits = 82, RULE_limitvalue = 83, RULE_maxrecords = 84, RULE_maxexpandedrecords = 85;

    private static String[] makeRuleNames() {
        return new String[] {"xsOdataDefinition", "service", "namespace", "body", "content", "entry", "entity", "object",
                "catalogobjectschema", "catalogobjectname", "entityset", "entitysetname", "with", "withProp", "withoutProp", "propertylist",
                "columnname", "keys", "keylist", "keygenerated", "concurrencytoken", "navigates", "navlist", "naventry", "assocname",
                "navpropname", "fromend", "principal", "dependent", "aggregates", "aggregatestuple", "aggregate", "aggregatefunction",
                "parameters", "parameterskeyand", "parameterentitysetname", "parametersresultsprop", "modificationBody", "modification",
                "create", "update", "delete", "modificationspec", "modificationaction", "forbidden", "action", "events", "eventlist",
                "eventlistElement", "eventtype", "association", "associationdef", "assocrefconstraint", "principalend", "dependentend",
                "end", "endref", "endtype", "joinpropertieslist", "multiplicity", "multiplicityvalue", "assoctable", "repoobject",
                "overprincipalend", "overdependentend", "overend", "storage", "nostorage", "storageend", "annotations", "annotationsbody",
                "annotationconfig", "settings", "settingsbody", "settingselement", "supportnull", "contentcashecontrol",
                "metadatacashecontrol", "hints", "hintlist", "hintvalue", "nullvalue", "limits", "limitvalue", "maxrecords",
                "maxexpandedrecords"};
    }
    ...
    private static String[] makeLiteralNames() {
        return new String[] {null, "'service'", "'namespace'", "'{'", "'}'", "'entity'", "'.'", "'as'", "'with'", "'without'", "'('", "')'",
                "'keys'", "'key'", "'generate'", "'local'", "'concurrencytoken'", "'navigates'", "'from'", "'principal'", "'dependent'",
                "'aggregates'", "'always'", "'of'", "'SUM'", "'AVG'", "'MIN'", "'MAX'", "'parameters'", "'via'", "'and'", "'results'",
                "'property'", "'create'", "'update'", "'delete'", "'using'", "'forbidden'", "'events'", "'before'", "'after'",
                "'precommit'", "'postcommit'", "'association'", "'referential'", "'constraint'", "'multiplicity'", "'\"1\"'", "'\"0..1\"'",
                "'\"1..*\"'", "'\"*\"'", "'over'", "'no'", "'storage'", "'on'", "'annotations'", "'enable'", "'OData4SAP'", "'settings'",
                "'support'", "'null'", "'content'", "'cache-control'", "'metadata'", "'hints'", "'limits'", "'max_records'",
    ...
    private static String[] makeSymbolicNames() {
        return new String[] {null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null,
                ...
                null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null,
                null, null, null, null, null, null, null, null, null, null, "SEMICOLON", "EQ", "QUATED_STRING", "COMMA", "COLON", "ESC",
                "WS", "LINE_COMMENT", "COMMENT", "INT"};
    }
    ...
    public static class XsOdataDefinitionContext extends ParserRuleContext {
        ...
        public int getRuleIndex() {
            return RULE_xsOdataDefinition;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterXsOdataDefinition(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitXsOdataDefinition(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitXsOdataDefinition(this);
            else
    ...
    public static class ServiceContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterService(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitService(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitService(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class NamespaceContext extends ParserRuleContext {
        public TerminalNode QUATED_STRING() {
            return getToken(XSODataParser.QUATED_STRING, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterNamespace(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitNamespace(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitNamespace(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class BodyContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterBody(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitBody(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitBody(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class ContentContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterContent(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitContent(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitContent(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class EntryContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterEntry(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitEntry(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitEntry(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class EntityContext extends ParserRuleContext {
        ...
        public TerminalNode SEMICOLON() {
            return getToken(XSODataParser.SEMICOLON, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterEntity(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitEntity(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitEntity(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class ObjectContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterObject(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitObject(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitObject(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class CatalogobjectschemaContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_catalogobjectschema;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterCatalogobjectschema(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitCatalogobjectschema(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitCatalogobjectschema(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class CatalogobjectnameContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_catalogobjectname;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterCatalogobjectname(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitCatalogobjectname(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitCatalogobjectname(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class EntitysetContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_entityset;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterEntityset(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitEntityset(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitEntityset(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class EntitysetnameContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_entitysetname;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterEntitysetname(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitEntitysetname(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitEntitysetname(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class WithContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterWith(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitWith(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitWith(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class WithPropContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_withProp;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterWithProp(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitWithProp(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitWithProp(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class WithoutPropContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_withoutProp;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterWithoutProp(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitWithoutProp(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitWithoutProp(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class PropertylistContext extends ParserRuleContext {
        ...
        public List<TerminalNode> COMMA() {
            return getTokens(XSODataParser.COMMA);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterPropertylist(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitPropertylist(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitPropertylist(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class ColumnnameContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterColumnname(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitColumnname(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitColumnname(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class KeysContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterKeys(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitKeys(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitKeys(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class KeylistContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterKeylist(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitKeylist(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitKeylist(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class KeygeneratedContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_keygenerated;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterKeygenerated(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitKeygenerated(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitKeygenerated(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class ConcurrencytokenContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_concurrencytoken;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterConcurrencytoken(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitConcurrencytoken(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitConcurrencytoken(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class NavigatesContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_navigates;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterNavigates(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitNavigates(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitNavigates(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class NavlistContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterNavlist(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitNavlist(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitNavlist(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class NaventryContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_naventry;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterNaventry(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitNaventry(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitNaventry(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class AssocnameContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_assocname;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterAssocname(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitAssocname(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitAssocname(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class NavpropnameContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_navpropname;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterNavpropname(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitNavpropname(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitNavpropname(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class FromendContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterFromend(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitFromend(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitFromend(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class PrincipalContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_principal;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterPrincipal(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitPrincipal(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitPrincipal(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class DependentContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterDependent(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitDependent(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitDependent(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class AggregatesContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterAggregates(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitAggregates(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitAggregates(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class AggregatestupleContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_aggregatestuple;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterAggregatestuple(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitAggregatestuple(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitAggregatestuple(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class AggregateContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterAggregate(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitAggregate(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitAggregate(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class AggregatefunctionContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_aggregatefunction;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterAggregatefunction(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitAggregatefunction(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitAggregatefunction(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class ParametersContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterParameters(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitParameters(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitParameters(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class ParameterskeyandContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_parameterskeyand;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterParameterskeyand(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitParameterskeyand(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitParameterskeyand(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class ParameterentitysetnameContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_parameterentitysetname;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterParameterentitysetname(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitParameterentitysetname(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitParameterentitysetname(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class ParametersresultspropContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_parametersresultsprop;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterParametersresultsprop(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitParametersresultsprop(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitParametersresultsprop(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class ModificationBodyContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_modificationBody;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterModificationBody(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitModificationBody(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitModificationBody(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class ModificationContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterModification(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitModification(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitModification(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class CreateContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterCreate(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitCreate(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitCreate(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class UpdateContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterUpdate(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitUpdate(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitUpdate(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class DeleteContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterDelete(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitDelete(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitDelete(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class ModificationspecContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_modificationspec;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterModificationspec(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitModificationspec(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitModificationspec(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class ModificationactionContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_modificationaction;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterModificationaction(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitModificationaction(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitModificationaction(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class ForbiddenContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_forbidden;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterForbidden(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitForbidden(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitForbidden(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class ActionContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterAction(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitAction(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitAction(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class EventsContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterEvents(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitEvents(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitEvents(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class EventlistContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_eventlist;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterEventlist(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitEventlist(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitEventlist(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class EventlistElementContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_eventlistElement;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterEventlistElement(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitEventlistElement(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitEventlistElement(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class EventtypeContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_eventtype;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterEventtype(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitEventtype(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitEventtype(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class AssociationContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterAssociation(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitAssociation(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitAssociation(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class AssociationdefContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_associationdef;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterAssociationdef(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitAssociationdef(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitAssociationdef(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class AssocrefconstraintContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_assocrefconstraint;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterAssocrefconstraint(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitAssocrefconstraint(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitAssocrefconstraint(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class PrincipalendContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_principalend;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterPrincipalend(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitPrincipalend(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitPrincipalend(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class DependentendContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_dependentend;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterDependentend(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitDependentend(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitDependentend(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class EndContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterEnd(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitEnd(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitEnd(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class EndrefContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterEndref(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitEndref(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitEndref(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class EndtypeContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterEndtype(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitEndtype(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitEndtype(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class JoinpropertieslistContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_joinpropertieslist;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterJoinpropertieslist(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitJoinpropertieslist(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitJoinpropertieslist(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class MultiplicityContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_multiplicity;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterMultiplicity(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitMultiplicity(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitMultiplicity(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class MultiplicityvalueContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_multiplicityvalue;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterMultiplicityvalue(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitMultiplicityvalue(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitMultiplicityvalue(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class AssoctableContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_assoctable;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterAssoctable(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitAssoctable(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitAssoctable(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class RepoobjectContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_repoobject;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterRepoobject(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitRepoobject(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitRepoobject(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class OverprincipalendContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_overprincipalend;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterOverprincipalend(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitOverprincipalend(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitOverprincipalend(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class OverdependentendContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_overdependentend;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterOverdependentend(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitOverdependentend(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitOverdependentend(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class OverendContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterOverend(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitOverend(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitOverend(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class StorageContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterStorage(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitStorage(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitStorage(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class NostorageContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_nostorage;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterNostorage(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitNostorage(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitNostorage(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class StorageendContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_storageend;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterStorageend(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitStorageend(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitStorageend(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class AnnotationsContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterAnnotations(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitAnnotations(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitAnnotations(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class AnnotationsbodyContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_annotationsbody;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterAnnotationsbody(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitAnnotationsbody(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitAnnotationsbody(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class AnnotationconfigContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_annotationconfig;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterAnnotationconfig(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitAnnotationconfig(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitAnnotationconfig(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class SettingsContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterSettings(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitSettings(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitSettings(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class SettingsbodyContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_settingsbody;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterSettingsbody(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitSettingsbody(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitSettingsbody(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class SettingselementContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_settingselement;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterSettingselement(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitSettingselement(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitSettingselement(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class SupportnullContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_supportnull;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterSupportnull(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitSupportnull(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitSupportnull(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class ContentcashecontrolContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_contentcashecontrol;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterContentcashecontrol(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitContentcashecontrol(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitContentcashecontrol(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class MetadatacashecontrolContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_metadatacashecontrol;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterMetadatacashecontrol(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitMetadatacashecontrol(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitMetadatacashecontrol(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class HintsContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterHints(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitHints(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitHints(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class HintlistContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterHintlist(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitHintlist(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitHintlist(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class HintvalueContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_hintvalue;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterHintvalue(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitHintvalue(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitHintvalue(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class NullvalueContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterNullvalue(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitNullvalue(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitNullvalue(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class LimitsContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterLimits(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitLimits(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitLimits(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class LimitvalueContext extends ParserRuleContext {
        public TerminalNode EQ() {
            return getToken(XSODataParser.EQ, 0);
        }

        public TerminalNode INT() {
            return getToken(XSODataParser.INT, 0);
        }
        ...
        @Override
        public int getRuleIndex() {
            return RULE_limitvalue;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterLimitvalue(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitLimitvalue(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitLimitvalue(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class MaxrecordsContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_maxrecords;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterMaxrecords(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitMaxrecords(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitMaxrecords(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class MaxexpandedrecordsContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_maxexpandedrecords;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).enterMaxexpandedrecords(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof XSODataListener)
                ((XSODataListener) listener).exitMaxexpandedrecords(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof XSODataVisitor)
                return ((XSODataVisitor<? extends T>) visitor).visitMaxexpandedrecords(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static final String _serializedATN = "\u0004\u0001M\u0245\u0002\u0000\u0007\u0000\u0002\u0001\u0007\u0001\u0002"
            + "\u0002\u0007\u0002\u0002\u0003\u0007\u0003\u0002\u0004\u0007\u0004\u0002"
            + "\u0005\u0007\u0005\u0002\u0006\u0007\u0006\u0002\u0007\u0007\u0007\u0002"
            + "\b\u0007\b\u0002\t\u0007\t\u0002\n\u0007\n\u0002\u000b\u0007\u000b\u0002"
            + "\f\u0007\f\u0002\r\u0007\r\u0002\u000e\u0007\u000e\u0002\u000f\u0007\u000f"
