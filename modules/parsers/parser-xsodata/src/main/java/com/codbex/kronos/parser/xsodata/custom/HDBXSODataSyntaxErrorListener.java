...
/**
 * The listener interface for receiving HDBXSODataSyntaxError events.
 * The class that is interested in processing a HDBXSODataSyntaxError
 * event implements this interface, and the object created
 * with that class is registered with a component using the
 * component's <code>addHDBXSODataSyntaxErrorListener</code> method. When
 * the HDBXSODataSyntaxError event occurs, that object's appropriate
 * method is invoked.
 *
 */
public class HDBXSODataSyntaxErrorListener extends BaseErrorListener {
