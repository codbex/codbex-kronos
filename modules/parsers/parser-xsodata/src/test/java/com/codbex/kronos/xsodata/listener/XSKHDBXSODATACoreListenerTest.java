...
import com.codbex.kronos.parser.xsodata.custom.XSKHDBXSODATACoreListener;
import com.codbex.kronos.parser.xsodata.model.XSKHDBXSODATAAggregation;
import com.codbex.kronos.parser.xsodata.model.XSKHDBXSODATAAggregationType;
import com.codbex.kronos.parser.xsodata.model.XSKHDBXSODATAAssociation;
import com.codbex.kronos.parser.xsodata.model.XSKHDBXSODATAAssociationTable;
import com.codbex.kronos.parser.xsodata.model.XSKHDBXSODATABinding;
import com.codbex.kronos.parser.xsodata.model.XSKHDBXSODATABindingRole;
import com.codbex.kronos.parser.xsodata.model.XSKHDBXSODATABindingType;
import com.codbex.kronos.parser.xsodata.model.XSKHDBXSODATAEntity;
import com.codbex.kronos.parser.xsodata.model.XSKHDBXSODATAEvent;
import com.codbex.kronos.parser.xsodata.model.XSKHDBXSODATAEventType;
import com.codbex.kronos.parser.xsodata.model.XSKHDBXSODATAHandlerMethod;
import com.codbex.kronos.parser.xsodata.model.XSKHDBXSODATAModification;
import com.codbex.kronos.parser.xsodata.model.XSKHDBXSODATAModificationSpec;
import com.codbex.kronos.parser.xsodata.model.XSKHDBXSODATAMultiplicityType;
import com.codbex.kronos.parser.xsodata.model.XSKHDBXSODATANavigation;
import com.codbex.kronos.parser.xsodata.model.XSKHDBXSODATARepositoryObject;
import com.codbex.kronos.parser.xsodata.model.XSKHDBXSODATAService;
import com.codbex.kronos.parser.xsodata.model.XSKHDBXSODATASetting;
import com.codbex.kronos.parser.xsodata.model.XSKHDBXSODATAStorage;
import com.codbex.kronos.parser.xsodata.model.XSKHDBXSODATAStorageType;
...
public class XSKHDBXSODATACoreListenerTest {
    ...
    public void parseServiceWithAssociationsSuccessfully() throws Exception {
        ...
        dependent.setMultiplicityType(XSKHDBXSODATAMultiplicityType.MANY);
        actualAssociation.setDependent(dependent);
        updateModification = new XSKHDBXSODATAModification().setMethod(XSKHDBXSODATAHandlerMethod.UPDATE).setSpecification(new XSKHDBXSODATAModificationSpec().setModificationAction("acme.test:oDataExtendedRules.xsjslib::associationToConditions"));
        table.setModifications(Arrays.asList(deleteModification, createModification, updateModification));
    ...
    public void parseServiceWithETagsSuccessfully() throws Exception {
        ...
        actualEntity = new XSKHDBXSODATAEntity();
        actualEntity.setRepositoryObject(new XSKHDBXSODATARepositoryObject().setCatalogObjectName("acme.test.odata.db.views::Etag"));
