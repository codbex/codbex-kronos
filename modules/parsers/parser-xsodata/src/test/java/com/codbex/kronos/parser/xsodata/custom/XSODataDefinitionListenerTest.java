...
public class XSODataDefinitionListenerTest {
  ...
  public void parseServiceWithObjectsSuccessfully() throws Exception {
    ...
    actualEntity.setRepositoryObject(
        new XSODataRepositoryObject().setCatalogObjectName("sample.odata::table").setCatalogObjectSchema("XSODATA_TEST"));
  ...
  public void parseServiceWithNavigationsSuccessfully() throws Exception {
    ...
    XSODataNavigation nav1 = new XSODataNavigation().setAssociation("Customer_Orders").setAliasNavigation("HisOrders");
    XSODataNavigation nav2 = new XSODataNavigation().setAssociation("Customer_Recruit").setAliasNavigation("Recruit").setFromBindingType(
    ...
    actualEntity.setNavigates(Collections.singletonList(
        new XSODataNavigation().setAssociation("Students_Grades").setAliasNavigation("HisGrades").setFromBindingType(
  ...
  public void parseServiceWithAggregationsSuccessfully() throws Exception {
    ...
    XSODataAggregation agg1 = new XSODataAggregation().setAggregateColumnName("Amount").setAggregateFunction("SUM");
    XSODataAggregation agg2 = new XSODataAggregation().setAggregateColumnName("Amount").setAggregateFunction("AVG");
    XSODataAggregation agg3 = new XSODataAggregation().setAggregateColumnName("Amount").setAggregateFunction("MIN");
    ...
    actualEntity.setAlias("Revenues");
    actualEntity.setKeyGenerated("ID");
    actualEntity.setAggregations(
        Collections.singletonList((new XSODataAggregation()).setAggregateColumnName("Amount").setAggregateFunction("MAX")));
    actualEntity.setAggregationType(XSODataAggregationType.EXPLICIT);
    assertEquals(model.getEntities().get(1), actualEntity);
  ...
  public void parseServiceWithEventsSuccessfully() throws Exception {
    ...
    updateModification.setSpecification(new XSODataModificationSpec().setEvents(
        Arrays.asList(new XSODataEvent(XSODataEventType.BEFORE, "sample.odata::beforeMethod"), new XSODataEvent(
            XSODataEventType.PRECOMMIT, "sample.odata::beforeMethod"))));
    XSODataModification deleteModification = new XSODataModification().setMethod(XSODataHandlerMethod.DELETE);
    deleteModification.setSpecification(new XSODataModificationSpec().setEvents(Collections.singletonList(new XSODataEvent(
    ...
    createModification.setSpecification(new XSODataModificationSpec().setModificationAction("sample.odata::createMethod"));
    updateModification = new XSODataModification().setMethod(XSODataHandlerMethod.UPDATE);
    updateModification.setSpecification(new XSODataModificationSpec().setEvents(Collections.singletonList(new XSODataEvent(
        XSODataEventType.PRECOMMIT, "sample.odata::precommitMethod"))));
    deleteModification = new XSODataModification().setMethod(XSODataHandlerMethod.DELETE)
  ...
  public void parseServiceWithAssociationsSuccessfully() throws Exception {
    ...
    principal.setBindingRole(
        new XSODataBindingRole().setBindingType(XSODataBindingType.PRINCIPAL).setKeys(Collections.singletonList("ID")));
    ...
    dependent.setBindingRole(
        new XSODataBindingRole().setBindingType(XSODataBindingType.DEPENDENT).setKeys(Collections.singletonList("ID_A")));
    ...
    table.setPrincipal(new XSODataBindingRole().setBindingType(XSODataBindingType.PRINCIPAL).setKeys(Collections.singletonList("ID_A")));
    table.setDependent(new XSODataBindingRole().setBindingType(XSODataBindingType.DEPENDENT).setKeys(Collections.singletonList("ID_B")));
    actualAssociation.setAssociationTable(table);
    assertEquals(model.getAssociations().get(0), actualAssociation);

    XSODataModification updateModification = new XSODataModification().setMethod(XSODataHandlerMethod.UPDATE);
    updateModification.setSpecification(new XSODataModificationSpec().setEvents(Collections.singletonList(new XSODataEvent(
        XSODataEventType.BEFORE, "sample.odata::updateMethod"))));
    XSODataModification deleteModification = new XSODataModification().setMethod(XSODataHandlerMethod.DELETE);
    deleteModification.setSpecification(new XSODataModificationSpec().setEvents(Collections.singletonList(new XSODataEvent(
        XSODataEventType.BEFORE, "sample.odata::deleteMethod"))));
    XSODataModification createModification = new XSODataModification().setMethod(XSODataHandlerMethod.CREATE);
    createModification.setSpecification(new XSODataModificationSpec().setEvents(Collections.singletonList(new XSODataEvent(
        XSODataEventType.BEFORE, "sample.odata::createMethod"))));
    ...
    dependent.setMultiplicityType(XSODataMultiplicityType.MANY);
    actualAssociation.setDependent(dependent);
    updateModification = new XSODataModification().setMethod(XSODataHandlerMethod.UPDATE).setSpecification(
        new XSODataModificationSpec().setModificationAction("sap.test:oDataExtendedRules.xsjslib::associationToConditions"));
    table.setModifications(Arrays.asList(deleteModification, createModification, updateModification));
    ...
    dependent.setEntitySetName("complex_c");
    dependent.setBindingRole(
        new XSODataBindingRole().setBindingType(XSODataBindingType.DEPENDENT).setKeys(Collections.singletonList("ID_B")));
  ...
  public void parseServiceWithETagsSuccessfully() throws Exception {
    ...
    XSODataNavigation nav1 = new XSODataNavigation().setAssociation("BusinessPartner_To_N_BPRole").setAliasNavigation("Roles");
  ...
  private XSODataParser parseSampleFile(String sampleFileName) throws Exception {
    String sample =
        org.apache.commons.io.IOUtils.toString(
            XSODataDefinitionListenerTest.class.getResourceAsStream(sampleFileName),
