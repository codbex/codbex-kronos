...
@XmlType(name = "IDObjectWithDescription", propOrder = {"descriptions"})
@XmlSeeAlso({Node.class, LocalVariable.class, ValueListEntry.class, LogicalColumn.class, LocalDimension.class, Hierarchy.class})
public abstract class IDObjectWithDescription extends IDObject {
