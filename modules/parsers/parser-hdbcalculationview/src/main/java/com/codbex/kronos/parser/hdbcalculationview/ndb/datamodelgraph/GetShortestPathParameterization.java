...
@XmlType(name = "GetShortestPathParameterization", propOrder = {"targetVertex", "targetVertexParameter"})
public class GetShortestPathParameterization extends GetShortestPathsParameterization {
