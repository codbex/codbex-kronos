...
@XmlType(name = "ParentChildHierarchy", propOrder = {"attributeParentPair", "siblingOrder", "timeProperties", "edgeAttribute"})
public class ParentChildHierarchy extends Hierarchy {
     ...
     *
     *
     * Objects of the following type(s) are allowed in the list {@link AttributeParentPair }
     *
     ...
     *
     *
     * Objects of the following type(s) are allowed in the list {@link SiblingOrder }
     *
