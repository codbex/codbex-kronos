...
/**
 * Data type including a semantic description. Replaces the ABAP data element in the CDS meta model
 *
 *
...
@XmlType(name = "SimpleType", propOrder = {"valueRange", "dataElementName"})
public class SimpleType extends DataType {
     ...
     *
     *
     * Objects of the following type(s) are allowed in the list {@link ValueRange }
     *
     ...
     *
     * @return possible object is {@link PrimitiveType }
     */
     ...
     *
     * @param value allowed object is {@link PrimitiveType }
     */
