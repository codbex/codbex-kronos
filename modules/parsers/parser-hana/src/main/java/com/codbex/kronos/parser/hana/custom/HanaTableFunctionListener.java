...
/**
 * The listener interface for receiving hanaTableFunction events. The class that is interested in
 * processing a hanaTableFunction event implements this interface, and the object created with that
 * class is registered with a component using the component's
 * <code>addHanaTableFunctionListener</code> method. When the hanaTableFunction event occurs, that
