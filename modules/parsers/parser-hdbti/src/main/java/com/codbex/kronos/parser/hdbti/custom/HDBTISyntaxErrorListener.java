...
/**
 * The listener interface for receiving HDBTISyntaxError events.
 * The class that is interested in processing a HDBTISyntaxError
 * event implements this interface, and the object created
 * with that class is registered with a component using the
 * component's <code>addHDBTISyntaxErrorListener</code> method. When
 * the HDBTISyntaxError event occurs, that object's appropriate
 * method is invoked.
 *
 */
