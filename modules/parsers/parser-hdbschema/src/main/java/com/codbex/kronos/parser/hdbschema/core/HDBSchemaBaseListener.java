...
/**
 * This class provides an empty implementation of {@link HDBSchemaListener}, which can be extended
...
public class HDBSchemaBaseListener implements HDBSchemaListener {
     ...
     */
    @Override
    public void enterHdbSchemaDefinition(HDBSchemaParser.HdbSchemaDefinitionContext ctx) {}
     ...
     */
    @Override
    public void enterSchemaNameProp(HDBSchemaParser.SchemaNamePropContext ctx) {}
     ...
     */
    @Override
    public void exitSchemaNameProp(HDBSchemaParser.SchemaNamePropContext ctx) {}
