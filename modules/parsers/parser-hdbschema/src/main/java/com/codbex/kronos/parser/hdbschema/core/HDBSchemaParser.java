...
public class HDBSchemaParser extends Parser {
    ...
    public static final int T__0 = 1, STRING = 2, EQ = 3, SEMICOLON = 4, COMMA = 5, WS = 6, ESC = 7, LINE_COMMENT = 8, COMMENT = 9;
    public static final int RULE_hdbSchemaDefinition = 0, RULE_schemaNameProp = 1;

    private static String[] makeRuleNames() {
        return new String[] {"hdbSchemaDefinition", "schemaNameProp"};
    }

    public static final String[] ruleNames = makeRuleNames();

    private static String[] makeLiteralNames() {
        return new String[] {null, "'schema_name'", null, "'='", "';'", "','"};
    }

    private static final String[] _LITERAL_NAMES = makeLiteralNames();

    private static String[] makeSymbolicNames() {
        return new String[] {null, null, "STRING", "EQ", "SEMICOLON", "COMMA", "WS", "ESC", "LINE_COMMENT", "COMMENT"};
    }
    ...
    public static class HdbSchemaDefinitionContext extends ParserRuleContext {
        ...
        public int getRuleIndex() {
            return RULE_hdbSchemaDefinition;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof HDBSchemaListener)
                ((HDBSchemaListener) listener).enterHdbSchemaDefinition(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof HDBSchemaListener)
                ((HDBSchemaListener) listener).exitHdbSchemaDefinition(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof HDBSchemaVisitor)
                return ((HDBSchemaVisitor<? extends T>) visitor).visitHdbSchemaDefinition(this);
            else
    ...
    public static class SchemaNamePropContext extends ParserRuleContext {
        public TerminalNode EQ() {
            return getToken(HDBSchemaParser.EQ, 0);
        }

        public TerminalNode STRING() {
            return getToken(HDBSchemaParser.STRING, 0);
        }

        public TerminalNode SEMICOLON() {
            return getToken(HDBSchemaParser.SEMICOLON, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof HDBSchemaListener)
                ((HDBSchemaListener) listener).enterSchemaNameProp(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof HDBSchemaListener)
                ((HDBSchemaListener) listener).exitSchemaNameProp(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof HDBSchemaVisitor)
                return ((HDBSchemaVisitor<? extends T>) visitor).visitSchemaNameProp(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static final String _serializedATN = "\u0004\u0001\t\f\u0002\u0000\u0007\u0000\u0002\u0001\u0007\u0001\u0001"
            + "\u0000\u0001\u0000\u0001\u0001\u0001\u0001\u0001\u0001\u0001\u0001\u0001"
            + "\u0001\u0001\u0001\u0000\u0000\u0002\u0000\u0002\u0000\u0000\t\u0000\u0004"
            + "\u0001\u0000\u0000\u0000\u0002\u0006\u0001\u0000\u0000\u0000\u0004\u0005"
            + "\u0003\u0002\u0001\u0000\u0005\u0001\u0001\u0000\u0000\u0000\u0006\u0007"
