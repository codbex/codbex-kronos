...
/**
 * The listener interface for receiving HDBSchemaSyntaxError events. The class that is interested in
 * processing a HDBSchemaSyntaxError event implements this interface, and the object created with
 * that class is registered with a component using the component's
 * <code>addHDBSchemaSyntaxErrorListener</code> method. When the HDBSchemaSyntaxError event occurs,
 * that object's appropriate method is invoked.
 *
 */
public class HDBSchemaSyntaxErrorListener extends BaseErrorListener {
