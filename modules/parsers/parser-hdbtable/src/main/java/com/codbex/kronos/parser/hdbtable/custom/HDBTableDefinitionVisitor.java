...
public class HDBTableDefinitionVisitor extends HDBTableBaseVisitor<JsonElement> {
    ...
    public JsonElement visitHdbTableDefinition(HdbTableDefinitionContext ctx) {
        ...
        for (ParseTree tree : ctxList) {
            if (tree.getChild(0) instanceof SchemaNamePropContext) {
                ...
                hdbtableObject.add(HDBTABLE_PROPERTY_PKCOLUMNS, visitTablePrimaryKeyProp((TablePrimaryKeyPropContext) tree.getChild(0)));
    ...
    public JsonElement visitIndexesObject(IndexesObjectContext ctx) {
        ...
        for (ParseTree tree : ctxList) {
            if (tree.getChild(0) instanceof IndexAssignNameContext) {
                ...
                indexesObject.add(INDEX_PROPERTY_INDEX_TYPE, visitIndexAssignIndexType((IndexAssignIndexTypeContext) tree.getChild(0)));
            }
        }
    ...
    public JsonElement visitColumnAssignUnique(ColumnAssignUniqueContext ctx) {
        return (ctx != null && ctx.BOOLEAN() != null) ? new JsonPrimitive(Boolean.parseBoolean(ctx.BOOLEAN()
                                                                                                  .getText()))
                : null;
    }
    ...
    public JsonElement visitColumnAssignDefaultValue(ColumnAssignDefaultValueContext ctx) {
        if (ctx != null && ctx.STRING() != null) {
            return new JsonPrimitive(handleStringLiteral(ctx.STRING()
                                                            .getText()));
        } else if (ctx != null && ctx.INT() != null) {
            return new JsonPrimitive(Integer.parseInt(ctx.INT()
                                                         .getText()));
        } else {
            return null;
        }
    ...
    public JsonElement visitColumnAssignName(ColumnAssignNameContext ctx) {
        return (ctx != null && ctx.STRING() != null) ? new JsonPrimitive(handleStringLiteral(ctx.STRING()
                                                                                                .getText()))
                : null;
    }
    ...
    public JsonElement visitColumnsObject(ColumnsObjectContext ctx) {
        ...
        for (ParseTree tree : ctxList) {
            if (tree.getChild(0) instanceof ColumnAssignNameContext) {
                ...
                columnsObject.add(COLUMN_PROPERTY_NULLABLE, visitColumnAssignNullable((ColumnAssignNullableContext) tree.getChild(0)));
                ...
                columnsObject.add(COLUMN_PROPERTY_PRECISION, visitColumnAssignPrecision((ColumnAssignPrecisionContext) tree.getChild(0)));
    ...
    public JsonElement visitTableTypeProp(TableTypePropContext ctx) {
        return (ctx != null && ctx.TABLETYPE() != null) ? new JsonPrimitive(ctx.TABLETYPE()
                                                                               .getText())
                : null;
    }
    ...
    public JsonElement visitColumnAssignLength(ColumnAssignLengthContext ctx) {
        return (ctx != null && ctx.INT() != null) ? new JsonPrimitive(Integer.parseInt(ctx.INT()
                                                                                          .getText()))
                : null;
    }
    ...
    public JsonElement visitTablePrimaryKeyIndexTypeProp(TablePrimaryKeyIndexTypePropContext ctx) {
        return (ctx != null && ctx.INDEXTYPE() != null) ? new JsonPrimitive(ctx.INDEXTYPE()
                                                                               .getText())
                : null;
    }
    ...
    public JsonElement visitColumnAssignSQLType(ColumnAssignSQLTypeContext ctx) {
        return (ctx != null && ctx.SQLTYPES() != null) ? new JsonPrimitive(ctx.SQLTYPES()
                                                                              .getText())
                : null;
    }
    ...
    public JsonElement visitLoggingTypeProp(LoggingTypePropContext ctx) {
        return (ctx != null && ctx.TABLELOGGINGTYPE() != null) ? new JsonPrimitive(ctx.TABLELOGGINGTYPE()
                                                                                      .getText())
                : null;
    }
    ...
    public JsonElement visitIndexAssignOrder(IndexAssignOrderContext ctx) {
        return (ctx != null && ctx.ORDER() != null) ? new JsonPrimitive(ctx.ORDER()
                                                                           .getText())
                : null;
    }
