...
/**
 * The listener interface for receiving HDBTableSyntaxError events.
 * The class that is interested in processing a HDBTableSyntaxError
 * event implements this interface, and the object created
 * with that class is registered with a component using the
 * component's <code>addHDBTableSyntaxErrorListener</code> method. When
 * the HDBTableSyntaxError event occurs, that object's appropriate
 * method is invoked.
 *
 */
