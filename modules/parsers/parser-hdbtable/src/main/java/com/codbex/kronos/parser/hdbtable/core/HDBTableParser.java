...
public class HDBTableParser extends Parser {
    ...
    public static final int T__0 = 1, T__1 = 2, T__2 = 3, T__3 = 4, T__4 = 5, T__5 = 6, T__6 = 7, T__7 = 8, T__8 = 9, T__9 = 10, T__10 = 11,
            ...
            T__21 = 22, T__22 = 23, T__23 = 24, T__24 = 25, T__25 = 26, T__26 = 27, STRING = 28, WS = 29, TABLE = 30, DOT = 31, EQ = 32,
            SEMICOLON = 33, SQLTYPES = 34, BOOLEAN = 35, ORDER = 36, INDEXTYPE = 37, INT = 38, TABLETYPE = 39, TABLELOGGINGTYPE = 40,
            DATETIMEDEFAULTVALUES = 41, LINE_COMMENT = 42, COMMENT = 43;
    public static final int RULE_hdbTableDefinition = 0, RULE_hdbTableProperties = 1, RULE_schemaNameProp = 2, RULE_temporaryProp = 3,
            RULE_tableTypeProp = 4, RULE_publicProp = 5, RULE_loggingTypeProp = 6, RULE_tableColumnsProp = 7, RULE_tableIndexesProp = 8,
            RULE_tablePrimaryKeyProp = 9, RULE_tablePrimaryKeyColumnsProp = 10, RULE_tablePrimaryKeyIndexTypeProp = 11,
            RULE_descriptionProp = 12, RULE_columnsObject = 13, RULE_columnsProperties = 14, RULE_indexesObject = 15,
            RULE_indexProperties = 16, RULE_columnAssignName = 17, RULE_columnAssignSQLType = 18, RULE_columnAssignNullable = 19,
            RULE_columnAssignUnique = 20, RULE_columnAssignLength = 21, RULE_columnAssignComment = 22, RULE_columnAssignDefaultValue = 23,
            RULE_columnAssignPrecision = 24, RULE_columnAssignScale = 25, RULE_indexAssignName = 26, RULE_indexAssignUnique = 27,
            RULE_indexAssignOrder = 28, RULE_indexAssignIndexColumns = 29, RULE_indexAssignIndexType = 30, RULE_indexColumnsArray = 31;

    private static String[] makeRuleNames() {
        return new String[] {"hdbTableDefinition", "hdbTableProperties", "schemaNameProp", "temporaryProp", "tableTypeProp", "publicProp",
                "loggingTypeProp", "tableColumnsProp", "tableIndexesProp", "tablePrimaryKeyProp", "tablePrimaryKeyColumnsProp",
                "tablePrimaryKeyIndexTypeProp", "descriptionProp", "columnsObject", "columnsProperties", "indexesObject", "indexProperties",
                "columnAssignName", "columnAssignSQLType", "columnAssignNullable", "columnAssignUnique", "columnAssignLength",
                "columnAssignComment", "columnAssignDefaultValue", "columnAssignPrecision", "columnAssignScale", "indexAssignName",
                "indexAssignUnique", "indexAssignOrder", "indexAssignIndexColumns", "indexAssignIndexType", "indexColumnsArray"};
    }

    public static final String[] ruleNames = makeRuleNames();

    private static String[] makeLiteralNames() {
        return new String[] {null, "'schemaName'", "'temporary'", "'tableType'", "'public'", "'loggingType'", "'columns'", "'['", "','",
                "']'", "'indexes'", "'primaryKey'", "'pkcolumns'", "'indexType'", "'description'", "'{'", "'}'", "'name'", "'sqlType'",
                "'nullable'", "'unique'", "'length'", "'comment'", "'defaultValue'", "'precision'", "'scale'", "'order'", "'indexColumns'",
                null, null, "'table'", "'.'", "'='", "';'"};
    }
    ...
    private static String[] makeSymbolicNames() {
        return new String[] {null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null,
                null, null, null, null, null, null, null, null, null, null, "STRING", "WS", "TABLE", "DOT", "EQ", "SEMICOLON", "SQLTYPES",
                "BOOLEAN", "ORDER", "INDEXTYPE", "INT", "TABLETYPE", "TABLELOGGINGTYPE", "DATETIMEDEFAULTVALUES", "LINE_COMMENT",
                "COMMENT"};
    }
    ...
    public static class HdbTablePropertiesContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_hdbTableProperties;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof HDBTableListener)
                ((HDBTableListener) listener).enterHdbTableProperties(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof HDBTableListener)
                ((HDBTableListener) listener).exitHdbTableProperties(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof HDBTableVisitor)
                return ((HDBTableVisitor<? extends T>) visitor).visitHdbTableProperties(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class ColumnsPropertiesContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_columnsProperties;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof HDBTableListener)
                ((HDBTableListener) listener).enterColumnsProperties(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof HDBTableListener)
                ((HDBTableListener) listener).exitColumnsProperties(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof HDBTableVisitor)
                return ((HDBTableVisitor<? extends T>) visitor).visitColumnsProperties(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class IndexPropertiesContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_indexProperties;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof HDBTableListener)
                ((HDBTableListener) listener).enterIndexProperties(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof HDBTableListener)
                ((HDBTableListener) listener).exitIndexProperties(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof HDBTableVisitor)
                return ((HDBTableVisitor<? extends T>) visitor).visitIndexProperties(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static final String _serializedATN = "\u0004\u0001+\u0132\u0002\u0000\u0007\u0000\u0002\u0001\u0007\u0001\u0002"
            + "\u0002\u0007\u0002\u0002\u0003\u0007\u0003\u0002\u0004\u0007\u0004\u0002"
            + "\u0005\u0007\u0005\u0002\u0006\u0007\u0006\u0002\u0007\u0007\u0007\u0002"
            + "\b\u0007\b\u0002\t\u0007\t\u0002\n\u0007\n\u0002\u000b\u0007\u000b\u0002"
            + "\f\u0007\f\u0002\r\u0007\r\u0002\u000e\u0007\u000e\u0002\u000f\u0007\u000f"
