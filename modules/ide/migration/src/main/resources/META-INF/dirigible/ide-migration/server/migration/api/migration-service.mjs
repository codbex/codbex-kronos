...
const hdbDDModel = "com.codbex.kronos.hdb.ds.model.hdbdd.CdsDataStructureModel";
const schemaModel = "com.codbex.kronos.hdb.ds.model.hdbschema.HDBSchemaDataStructureModel";
