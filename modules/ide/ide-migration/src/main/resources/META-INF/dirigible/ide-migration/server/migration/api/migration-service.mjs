...
const XSKProjectMigrationInterceptor = Java.type("com.codbex.kronos.modificators.XSKProjectMigrationInterceptor");
const XSKHDBCoreFacade = Java.type("com.codbex.kronos.hdb.ds.facade.XSKHDBCoreSynchronizationFacade");
const hdbDDModel = "com.codbex.kronos.hdb.ds.model.hdbdd.XSKDataStructureCdsModel";
const schemaModel = "com.codbex.kronos.hdb.ds.model.hdbschema.XSKDataStructureHDBSchemaModel";
