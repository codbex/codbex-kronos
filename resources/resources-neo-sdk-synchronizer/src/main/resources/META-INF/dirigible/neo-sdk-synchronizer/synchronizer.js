...
function getNeoSdkResourcesPath() {
    ...
    let neoSdkResourcesPath = files.list(libPath).filter(e => e.contains("resources-neo-sdk") && !e.contains("resources-neo-sdk-synchronizer"))[0];
...
function isNeoSdkFile(zipEntry) {
    ...
    return !zipEntry.isDirectory() && filePath != "" && filePath != "F" && filePath != "MANIFEST.MF" && !filePath.startsWith("maven/") && !filePath.startsWith("codbex.kronos/");
}
