...
public class NeoSdkResourcesSynchronizer extends AbstractSynchronizer {

	private static final Logger logger = LoggerFactory.getLogger(NeoSdkResourcesSynchronizer.class);
	...
	public void synchronize() {
		try {
			...
			executor.submit(() -> {
				HealthStatus.getInstance().getJobs().setStatus(NeoSdkResourcesSynchronizerJobDefinitionProvider.KRONOS_NEO_SDK_RESOURCES_SYNCHRONIZER_JOB_NAME, JobStatus.Succeeded);
