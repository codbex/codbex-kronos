...
public class XSODataSynchronizer extends BaseSynchronizer<XSOData, Long> {
  ...
  public void generateOData(XSOData model) throws SQLException {
    ...
    ODataContainer odataContainer = new ODataContainer(oDataDefinition.getLocation(), oDataDefinition.getName(), null, null,
        odatac.getBytes());
    ...
    for (String odatam : odatams) {
      ODataMapping odataMapping = new ODataMapping(oDataDefinition.getLocation(), oDataDefinition.getName() + "#" + i++, null, null,
          odatam.getBytes());
