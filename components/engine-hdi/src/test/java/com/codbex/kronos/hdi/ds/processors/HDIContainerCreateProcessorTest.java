...
public class HDIContainerCreateProcessorTest {
    ...
    public void testExecute() throws SQLException, IOException, DataStructuresException {
        ...
        GrantPrivilegesContainerGroupAPIProcessor grantPrivilegesContainerGroupAPIProcessor =
                Mockito.mock(GrantPrivilegesContainerGroupAPIProcessor.class);
        ...
        GrantPrivilegesContainerGroupProcessor grantPrivilegesContainerGroupProcessor =
                Mockito.mock(GrantPrivilegesContainerGroupProcessor.class);
        ...
        GrantPrivilegesContainerAPIProcessor grantPrivilegesContainerAPIProcessor =
                Mockito.mock(GrantPrivilegesContainerAPIProcessor.class);
        ...
        GrantPrivilegesContainerSchemaProcessor grantPrivilegesContainerSchemaProcessor =
                Mockito.mock(GrantPrivilegesContainerSchemaProcessor.class);
        GrantPrivilegesExternalArtifactsSchemaProcessor grantPrivilegesExternalArtifactsSchemaProcessor =
                Mockito.mock(GrantPrivilegesExternalArtifactsSchemaProcessor.class);
        ...
        HDIContainerCreateProcessor processor = new HDIContainerCreateProcessor(grantPrivilegesContainerGroupAPIProcessor,
                createContainerGroupProcessor, grantPrivilegesContainerGroupProcessor, createContainerProcessor,
                grantPrivilegesContainerAPIProcessor, writeContainerContentProcessor, configureLibrariesProcessor,
                deployContainerContentProcessor, grantPrivilegesContainerSchemaProcessor, grantPrivilegesExternalArtifactsSchemaProcessor,
        ...
        verify(grantPrivilegesDefaultRoleProcessor, times(1)).execute(mockConnection, hdiModel.getContainer(),
                Configuration.get("HANA_USERNAME"), hdiModel.getDeploy());
    }
