...
migrationLaunchView.controller("ChangesViewController", [
    ...
    function ($scope, $http, $messageHub, $timeout, migrationDataState, migrationViewState) {
        ...
        function getDiffData() {
            ...
            $http
                .post(
                    "/services/js/ide-migration/server/migration/api/migration-rest-api.mjs/get-process",
        ...
        function continueMigration() {
            ...
            $http
                .post("/services/js/ide-migration/server/migration/api/migration-rest-api.mjs/continue-process", JSON.stringify(body), {
                    headers: { "Content-Type": "application/json" },
                })
                .then((response) => {
