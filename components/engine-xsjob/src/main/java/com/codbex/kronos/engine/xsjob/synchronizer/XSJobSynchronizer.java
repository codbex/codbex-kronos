...
@Component
@Order(220)
public class XSJobSynchronizer extends BaseSynchronizer<XSJob, Long> {
   ...
   * The xsjob service.
   */
  private final XSJobService xsjobService;
   ...
   */
  @Override
  public XSJobService getService() {
    return xsjobService;
  }
  ...
  public List<XSJob> parse(String location, byte[] content) throws ParseException {
    JobArtifact jobArtifact = GsonHelper.fromJson(new InputStreamReader(new ByteArrayInputStream(content), StandardCharsets.UTF_8),
        JobArtifact.class);
   ...
   */
  @Override
  public void setStatus(XSJob artefact, ArtefactLifecycle lifecycle, String error) {
   ...
   */
  @Override
  public boolean completeImpl(TopologyWrapper<XSJob> wrapper, ArtefactPhase flow) {
