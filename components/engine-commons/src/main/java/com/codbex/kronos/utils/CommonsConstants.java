...
public final class CommonsConstants {
  ...
  /**
   * The Constant PROCESSOR_ERROR.
   */
  public static final String PROCESSOR_ERROR = "PROCESSOR";

  /**
   * The Constant LEXER_ERROR.
   */
