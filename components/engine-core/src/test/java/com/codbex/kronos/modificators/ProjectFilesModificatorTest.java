...
public class ProjectFilesModificatorTest {
    ...
    // assertEquals("myview",
    // projectFilesModificator.processModelUri("/TEST.VIEWS/calculationviews/myview"));
    // }
    //
    // @Test
    // public void testModifyAnalyticPrivilegeModelUriWhenCorrect() {
    // assertEquals("test.tinydb::myview",
    // projectFilesModificator.processModelUri("test.tinydb::myview"));
    // }
    //
    // @Test
    ...
    // projectFilesModificator.processWhereSql("SELECT \"HANAUserName\" FROM
    // \"_SYS_BIC\".\"APP.VIEWS/CALCVIEW\""));
    // }
    //
    // @Test
    ...
    // {
    // byte[] expectedModifiedFile =
    // getByteArrayFromResourceName("/META-INF/modificators/expected-results/" + fileName);
    // byte[] fileContent = getByteArrayFromResourceName("/META-INF/modificators/files-to-modify/" +
    // fileName);
    ...
    // }
    //
    // private void modifyProjectFilesAssertArrayEqualsWhenEmptyContent(String fileName) throws
    // IOException {
    ...
    // }
    //
    // private void modifyProjectFilesAssertArrayEqualsWhenNoModification(String fileName) throws
    // IOException {
    // byte[] fileContent = getByteArrayFromResourceName("/META-INF/modificators/files-to-modify/" +
    // fileName);
    // List<File> projectFiles = getProjectFiles(fileName, fileContent);
