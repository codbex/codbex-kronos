...
public class XsjslibSynchronizer extends BaseSynchronizer<Xsjslib, Long> {
     ...
     */
    @Autowired
    public XsjslibSynchronizer(XsjslibService xsjslibService, IRepository repository, JavascriptService javascriptService) {
    ...
    public void cleanupImpl(Xsjslib xsjslib) {
        try {
            IResource resource =
                    repository.getResource(IRepositoryStructure.PATH_REGISTRY_PUBLIC + xsjslib.getLocation() + "_generated_exports.js");
            if (resource.exists()) {
                resource.delete();
            }
    ...
    private Map<Object, Object> buildContext(Xsjslib xsjslib) {
        ...
        XsjslibSynchronizerRegistryEntity synchronizerTarget =
                new XsjslibSynchronizerRegistryEntity(IRepositoryStructure.PATH_REGISTRY_PUBLIC + xsjslib.getLocation(), repository);
