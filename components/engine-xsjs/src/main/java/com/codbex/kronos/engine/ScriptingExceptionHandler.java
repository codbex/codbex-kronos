...
public class ScriptingExceptionHandler { // extends AbstractExceptionHandler<ScriptingDependencyException> {
    ...
    // * (non-Javadoc)
    // * @see
    // org.eclipse.dirigible.commons.api.service.AbstractExceptionHandler#getResponseStatus(java.lang.Throwable)
    // */
    // @Override
    ...
    // * (non-Javadoc)
    // * @see
    // org.eclipse.dirigible.commons.api.service.AbstractExceptionHandler#getResponseMessage(java.lang.Throwable)
    // */
    // @Override
