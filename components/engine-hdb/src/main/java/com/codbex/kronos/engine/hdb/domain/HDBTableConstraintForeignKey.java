...
public class HDBTableConstraintForeignKey extends HDBTableConstraint {
     ...
     */
    public HDBTableConstraintForeignKey(String name, String[] modifiers, String[] columns, String referencedTable, String referencedSchema,
            String[] referencedColumns, HDBTableConstraints constraints) {
     ...
     * @param constraints the constraints
     */
    public HDBTableConstraintForeignKey(String referencedTable, String referencedSchema, String columnName, String referencedColumnName,
            HDBTableConstraints constraints) {
