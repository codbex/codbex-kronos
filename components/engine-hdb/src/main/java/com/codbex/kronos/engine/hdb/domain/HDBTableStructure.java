 ...
 */
@Entity
@jakarta.persistence.Table(name = "KRONOS_TABLESTRUCTURES")
public class HDBTableStructure extends HDBDataStructure {
    ...
    /**
     * Instantiates a new HDB table structure.
     *
     ...
     */
    public HDBTableStructure(String location, String name, String description, String dependencies, String schema, String content,
            boolean classic, String tableType, Boolean isPublic, String loggingType, Boolean isTemporary) {
    ...
    public String toString() {
        return "HDBTableStructure [id=" + id + ", columns=" + columns + ", primaryKey=" + primaryKey + ", location=" + location + ", name="
                + name + ", type=" + type + ", description=" + description + ", key=" + key + ", dependencies=" + dependencies
                + ", lifecycle=" + lifecycle + ", phase=" + phase + ", error=" + error + ", createdBy=" + createdBy + ", createdAt="
