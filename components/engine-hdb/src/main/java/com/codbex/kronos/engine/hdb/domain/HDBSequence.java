...
public class HDBSequence extends HDBDataStructure {
	 ...
	 */
	public HDBSequence(String location, String name, String description, String dependencies,
			String schema, String content, boolean classic, Long id, Integer incrementBy, Integer startWith,
			Integer maxValue, Boolean noMaxValue, Integer minValue, Boolean noMinValue, Boolean cycles, String resetBy,
			String dependsOnTable, String dependsOnView, Boolean isPublic) {
	...
	public String toString() {
		return "HDBSequence [id=" + id + ", incrementBy=" + incrementBy + ", startWith=" + startWith + ", maxValue="
				+ maxValue + ", noMaxValue=" + noMaxValue + ", minValue=" + minValue + ", noMinValue=" + noMinValue
				+ ", cycles=" + cycles + ", resetBy=" + resetBy + ", dependsOnTable=" + dependsOnTable
				+ ", dependsOnView=" + dependsOnView + ", isPublic=" + isPublic + ", location=" + location + ", name="
				+ name + ", type=" + type + ", description=" + description + ", key=" + key + ", dependencies="
				+ dependencies + ", lifecycle=" + lifecycle + ", phase=" + phase + ", error=" + error + ", createdBy="
