...
public class HDBDataStructure extends Artefact {
     ...
     */
    protected HDBDataStructure(String location, String name, String type, String description, String dependencies, String schema,
    ...
    public String toString() {
        return "HDBDataStructure [schema=" + schema + ", content=" + content + ", classic=" + classic + ", location=" + location + ", name="
