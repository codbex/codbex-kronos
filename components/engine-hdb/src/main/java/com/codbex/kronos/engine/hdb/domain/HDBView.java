...
public class HDBView extends HDBDataStructure {
    ...
    public String toString() {
        return "HDBView [id=" + id + ", query=" + query + ", isPublic=" + isPublic + ", dependsOn=" + dependsOn + ", dependsOnTable="
                + dependsOnTable + ", dependsOnView=" + dependsOnView + ", location=" + location + ", name=" + name + ", type=" + type
