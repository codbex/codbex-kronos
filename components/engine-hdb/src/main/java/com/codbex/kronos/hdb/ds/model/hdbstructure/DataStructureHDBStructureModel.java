 ...
 */
package com.codbex.kronos.hdb.ds.model.hdbstructure;
 ...
 */
public class DataStructureHDBStructureModel extends DataStructureModel {
  ...
  /** The primary key. */
  private DataStructureHDBStructurePrimaryKeyModel primaryKey = new DataStructureHDBStructurePrimaryKeyModel();
   ...
   */
  public DataStructureHDBStructurePrimaryKeyModel getPrimaryKey() {
    return primaryKey;
  }
   ...
   */
  public void setPrimaryKey(DataStructureHDBStructurePrimaryKeyModel primaryKey) {
