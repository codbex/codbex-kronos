 ...
 */
public class HDBTableFunctionDataStructureParser implements DataStructureParser<DataStructureHDBTableFunctionModel> {
   ...
   */
  public HDBTableFunctionDataStructureParser(
