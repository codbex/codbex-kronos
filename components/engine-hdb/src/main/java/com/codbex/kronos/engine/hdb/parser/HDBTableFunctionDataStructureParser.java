...
public class HDBTableFunctionDataStructureParser implements HDBDataStructureParser<HDBTableFunction> {
   ...
   */
  @Override
  public HDBTableFunction parse(HDBParameters parametersModel)
   ...
   * @return the data structure HDB table function model
   */
  private HDBTableFunction createModel(TableFunctionDefinitionModel antlrModel,
      HDBParameters params) {
