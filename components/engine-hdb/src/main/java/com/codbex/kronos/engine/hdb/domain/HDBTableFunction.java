...
public class HDBTableFunction extends HDBDataStructure {
     ...
     */
    protected HDBTableFunction(String location, String name, String description, String dependencies, String schema, String content,
            boolean classic) {
    ...
    public String toString() {
        return "HDBTableFunction [id=" + id + ", location=" + location + ", name=" + name + ", type=" + type + ", description="
