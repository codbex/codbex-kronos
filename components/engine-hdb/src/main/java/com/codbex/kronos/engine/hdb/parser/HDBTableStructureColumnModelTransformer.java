 ...
 */
public class HDBTableStructureColumnModelTransformer {
     ...
     * @return the list
     */
    public List<HDBTableStructureColumn> transform(HDBTableDefinitionModel hdbtableDefinitionModel, String location) {

        List<HDBTableStructureColumn> columns = new ArrayList<>();
        ...
        for (HDBTableColumnsModel column : hdbtableDefinitionModel.getColumns()) {
            ...
            HDBTableStructureColumn dataStructureHDBTableColumnModel = new HDBTableStructureColumn();
            ...
            List<String> foundMatchKey = hdbtableDefinitionModel.getPkColumns()
                                                                .stream()
                                                                .filter(key -> key.equals(column.getName()))
