...
@Service
@Transactional
public class HDBSchemaService extends BaseArtefactService<HDBSchema, Long> implements InitializingBean {
  ...
  protected HDBSchemaService(HDBSchemaRepository repository) {
    super(repository);
  }
