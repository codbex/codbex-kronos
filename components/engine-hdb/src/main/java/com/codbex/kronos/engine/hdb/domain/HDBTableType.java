...
public class HDBTableType extends HDBDataStructure {
    ...
    /**
     * Instantiates a new HDB table type.
     *
     ...
     */
    public HDBTableType(String location, String name, String description, String dependencies, String schema, String content,
    ...
    public String toString() {
        return "HDBTableType [id=" + id + ", columns=" + columns + ", primaryKey=" + primaryKey + ", location=" + location + ", name="
