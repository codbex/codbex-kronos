...
public class HDBTableStructureColumn extends HDBColumn {
     ...
     */
    public HDBTableStructureColumn(String name, String type, String length, boolean nullable, boolean primaryKey, String defaultValue,
            String scale, boolean unique, HDBTableStructure tableStructure) {
        super(name, type, length, nullable, primaryKey, defaultValue, scale, unique);
        this.tableStructure = tableStructure;
        this.tableStructure.getColumns()
                           .add(this);
    }
     ...
     * @param type the type
     * @param length the length
     * @param tableStrucutre the table strucutre
     */
     ...
     *
     * @param tableStrucutre the new table structure
     */
