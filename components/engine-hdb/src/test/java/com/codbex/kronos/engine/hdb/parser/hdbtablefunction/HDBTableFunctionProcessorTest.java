...
public class HDBTableFunctionProcessorTest {
    ...
    public void executeCreateTableFunctionSuccessfully(boolean doExist, int expectedTimesOfInvocation) throws IOException, SQLException {
        try (MockedStatic<SqlFactory> sqlFactory = Mockito.mockStatic(SqlFactory.class);
            ...
            String hdbTableFunctionSample = IOUtils.toString(HDBTableFunctionProcessorTest.class.getResourceAsStream(
                    "/registry/public/tablefunction/OrderTableFunction.hdbtablefunction"), StandardCharsets.UTF_8);

            HDBDataStructureModelBuilder builder = new HDBDataStructureModelBuilder().withContent(hdbTableFunctionSample)
    ...
    public void executeCreateTableFunctionPostgresSQLFailed() throws Exception {
        IllegalStateException exception = Assertions.assertThrows(IllegalStateException.class, () -> {
            ...
            HDBDataStructureModelBuilder builder = new HDBDataStructureModelBuilder().withName("\"MYSCHEMA\".\"hdb_view::FUNCTION_NAME\"")
                                                                                     .withType("HDBTABLEFUNCTION");
            HDBTableFunction model = new HDBTableFunction(builder);
