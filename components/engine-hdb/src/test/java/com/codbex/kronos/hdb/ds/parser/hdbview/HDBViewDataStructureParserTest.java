...
//    DataStructureHDBViewModel model = HDBDataStructureModelFactory.parseView("/ItemsByOrderHANAv1.hdbview", hdbviewSample);
...
//    DataStructureHDBViewModel model = HDBDataStructureModelFactory.parseView("hdb_view/db/ItemsByOrderHANAv2.hdbview", hdbviewSample);
...
//    DataStructureHDBViewModel model = HDBDataStructureModelFactory.parseView("hdb_view/db/ItemsByOrderHANAv2.hdbview", content);
//    assertEquals(DBContentType.OTHERS, model.getDBContentType());
...
//    HDBDataStructureModelFactory.parseView("hdb_view/db/test.hdbview", content);
//  }
//
//  @Test(expected = ArtifactParserException.class)
