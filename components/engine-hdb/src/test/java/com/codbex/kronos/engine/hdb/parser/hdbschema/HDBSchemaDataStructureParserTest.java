...
public class HDBSchemaDataStructureParserTest {
    ...
    public void parseHdbschemaFileSuccessfully() throws Exception {
        String hdbschemaSample = org.apache.commons.io.IOUtils.toString(
                HDBSchemaDataStructureParserTest.class.getResourceAsStream("/Myschema.hdbschema"), StandardCharsets.UTF_8);
    ...
    public void parseHanaXSClassicContentWithLexerErrorFail() throws Exception {
        ...
        Assertions.assertEquals(
                "Wrong format of HDB HDB Schema: [db/test.hdbschema] during parsing. Ensure you are using the correct format for the correct compatibility version.",
