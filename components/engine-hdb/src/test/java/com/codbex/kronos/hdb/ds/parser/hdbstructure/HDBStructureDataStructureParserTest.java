...
public class HDBStructureDataStructureParserTest {
...
//    DataStructureHDBStructureModel model = HDBDataStructureModelFactory.parseStructure("/ParsingHDBStructure.hdbstructure", contents);
//
