...
public class SynonymProcessorTest {
...
//        StandardCharsets.UTF_8);
//
//    DataStructureHDBSynonymModel model = HDBDataStructureModelFactory.parseSynonym("hdb_view/MySynonym.hdbsynonym", hdsynonymSample);
//    model.setName("\"MYSCHEMA\".\"hdb_view::MySynonym\"");
//    String mockSQL = "testSQLScript";
//
//    try (MockedStatic<SqlFactory> sqlFactory = Mockito.mockStatic(SqlFactory.class);
