...
//        DataStructureHDBTableModel model = HDBDataStructureModelFactory.parseTable("/Sports.hdbtable", contents);
//
...
//        DataStructureHDBTableModel model = HDBDataStructureModelFactory.parseTable("/HdbtableHanaXSAdvancedContent.hdbtable", content);
...
//        DataStructureHDBTableModel model = HDBDataStructureModelFactory.parseTable("/testFileName.hdbtable", content);
//        assertEquals(DBContentType.OTHERS, model.getDBContentType());
//        assertEquals(content, model.getRawContent());
//    }
//
...
//                "];";
//        DataStructureHDBTableModel model = HDBDataStructureModelFactory.parseTable("/test.hdbtable", content);
//        assertEquals(DBContentType.XS_CLASSIC, model.getDBContentType());
//        assertEquals(content, model.getRawContent());
//    }
//
...
//      String contents = IOUtils.toString(in, StandardCharsets.UTF_8);
//      DataStructureHDBTableModel model = HDBDataStructureModelFactory.parseTable("/ParsingTableWithUniqueAndNoUniqueIndexes.hdbtable", contents);
//
...
//      String contents = IOUtils.toString(in, StandardCharsets.UTF_8);
//
//      DataStructureHDBTableModel model = HDBDataStructureModelFactory.parseTable(hdbTablePath, contents);
//
