...
public class HDBTestModule implements IDirigibleModule {
    ...
    public static LocalResource getResources(String rootFolder, String repoPath, String relativeResourcePath) throws IOException {
        ...
        byte[] content = HDBTestModule.class.getResourceAsStream(relativeResourcePath)
                                            .readAllBytes();
    ...
    public void configure() {
        ...
        managerServices.put(IDataStructureModel.TYPE_HDB_TABLE_TYPE,
                new HDBTableTypeManagerService(new HDBSynonymRemover(synonymManagerService)));
        managerServices.put(IDataStructureModel.TYPE_HDB_STRUCTURE,
                new HDBStructureManagerService(new HDBSynonymRemover(synonymManagerService)));
    }
}
