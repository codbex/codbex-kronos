    ...
    public JsonObject getServiceCredentials(@Nonnull String serviceName, @Nullable String servicePlan) throws CloudPlatformException {
        ...
        switch (serviceName) {
            ...
            case "connectivity":
                ...
                credentialsObject.addProperty(ONPREMISE_PROXY_HTTP_PORT,
                        Configuration.get(DIRIGIBLE_CONNECTIVITY_ONPREMISE_PROXY_HTTP_PORT));
                credentialsObject.addProperty(ONPREMISE_PROXY_LDAP_PORT,
                        Configuration.get(DIRIGIBLE_CONNECTIVITY_ONPREMISE_PROXY_LDAP_PORT));
                ...
                credentialsObject.addProperty(ONPREMISE_SOCKS5_PROXY_PORT,
                        Configuration.get(DIRIGIBLE_CONNECTIVITY_ONPREMISE_SOCKS5_PROXY_PORT));
                break;
            default:
                throw new IllegalArgumentException("Retrieving credentials for service [" + serviceName + "] not supported");
        }
