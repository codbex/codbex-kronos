...
public class JobHandler implements Job {
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        String module = (String) context.getJobDetail()
                                        .getJobDataMap()
                                        .get(SchedulerManager.KRONOS_JOB_MODULE);
        Map<String, String> parametersAsMap = (Map<String, String>) context.getJobDetail()
                                                                           .getJobDataMap()
                                                                           .get(SchedulerManager.KRONOS_JOB_PARAMETERS);
        Object[] parametersArray = parametersAsMap.values()
                                                  .toArray();

        Map<Object, Object> executionContext = new HashMap<>();
        executionContext.put(SchedulerManager.KRONOS_JOB_FUNCTION, context.getJobDetail()
                                                                          .getJobDataMap()
                                                                          .get(SchedulerManager.KRONOS_JOB_FUNCTION));
        ...
        executionContext.put(SchedulerManager.KRONOS_JOB_DESCRIPTION, context.getJobDetail()
                                                                             .getDescription());
        try {
            ...
            CommonsUtils.logProcessorErrors(e.getMessage(), CommonsConstants.PROCESSOR_ERROR, context.getJobDetail()
                                                                                                     .getDescription(),
