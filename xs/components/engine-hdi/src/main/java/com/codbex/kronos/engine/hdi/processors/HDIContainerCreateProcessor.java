...
public class HDIContainerCreateProcessor {
    ...
    public HDIContainerCreateProcessor() {
        this(new GrantPrivilegesContainerGroupAPIProcessor(), new CreateContainerGroupProcessor(),
                new GrantPrivilegesContainerGroupProcessor(), new CreateContainerProcessor(), new GrantPrivilegesContainerAPIProcessor(),
                new WriteContainerContentProcessor(), new ConfigureLibrariesProcessor(), new DeployContainerContentProcessor(),
                new GrantPrivilegesContainerSchemaProcessor(), new GrantPrivilegesExternalArtifactsSchemaProcessor(),
                new GrantPrivilegesDefaultRoleProcessor());
    }

    /**
     * Instantiates a new HDI container create processor.
     *
     * @param grantPrivilegesContainerGroupAPIProcessor the grant privileges container group API
     *        processor
     ...
     * @param grantPrivilegesExternalArtifactsSchemaProcessor the grant privileges external artifacts
     *        schema processor
     * @param grantPrivilegesDefaultRoleProcessor the grant privileges default role processor
     */
    public HDIContainerCreateProcessor(GrantPrivilegesContainerGroupAPIProcessor grantPrivilegesContainerGroupAPIProcessor,
            ...
            CreateContainerProcessor createContainerProcessor, GrantPrivilegesContainerAPIProcessor grantPrivilegesContainerAPIProcessor,
            WriteContainerContentProcessor writeContainerContentProcessor, ConfigureLibrariesProcessor configureLibrariesProcessor,
            ...
            GrantPrivilegesDefaultRoleProcessor grantPrivilegesDefaultRoleProcessor) { // NOSONAR
    ...
    public void execute(Connection connection, HDI hdiModel) throws com.codbex.kronos.engine.hdb.api.DataStructuresException {
        ...
        try {
            ...
            this.writeContainerContentProcessor.execute(connection, hdiModel.getContainer(), hdiModel.getDeploy(),
                    hdiModel.getConfiguration());
