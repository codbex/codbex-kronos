...
public class Message {
     ...
     */
    public Message(long requestId, long rowId, int level, String type, String library, String pluginId, String path, String severity,
            long messageCode, String message, String location, String locationPath, Timestamp timestampUTC) {
        super();
