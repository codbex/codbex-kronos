...
import com.codbex.kronos.engine.xsodata.config.XSODataContextAware;
...
public class XSODataInitializerTest {
    ...
    private XSODataContextAware xsoDataInitializer;
    ...
    @BeforeEach
    public void setUp() {
        xsoDataInitializer = new XSODataContextAware();
    }
    ...
    public void testWhenValidationPatternIsPatchedNamesCanHaveDot() throws EdmException {
        xsoDataInitializer.setApplicationContext(null);
    ...
    /**
     * Test when validation patcher throws exception new illegal state exception is thrown.
     *
    ...
    public void testWhenValidationPatcherThrowsExceptionNewIllegalStateExceptionIsThrown() throws ReflectiveOperationException {
        ...
        doThrow(ReflectiveOperationException.class).when(odataInternalValidationPatternPatcherMock)
                                                   .patch();
        ...
        var illegalStateException = assertThrows(IllegalStateException.class, () -> xsoDataInitializer.setApplicationContext(null));

        assertEquals("Failed to replace default Olingo OData parameter name pattern.", illegalStateException.getMessage(),
                "Unexpected exception message");
        MatcherAssert.assertThat("Unexpected exception cause", illegalStateException.getCause(),
