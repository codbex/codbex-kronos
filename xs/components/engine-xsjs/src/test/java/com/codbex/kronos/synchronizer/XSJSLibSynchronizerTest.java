...
public class XSJSLibSynchronizerTest { // extends XSJSTest {
    ...
    // XSJSLibSynchronizer.forceSynchronization("../../test/kronos/import/"); // look two directories
    // back as the test resources are outside the repository root
    //
    ...
    // Map<Object, Object> context = new HashMap<>();
    // GraaliumJavascriptEngineExecutor graaliumJavascriptEngineExecutor = new
    // GraaliumJavascriptEngineExecutor();
