...
/**
 * The Class XSJSLibExportsGenerationSourceNotFoundExceptionTest.
 */
public class XSJSLibExportsGenerationSourceNotFoundExceptionTest {
    ...
    // XSJSLibExportsGenerationSourceNotFoundException exception = new
    // XSJSLibExportsGenerationSourceNotFoundException("test");
    ...
    // XSJSLibExportsGenerationSourceNotFoundException exception = new
    // XSJSLibExportsGenerationSourceNotFoundException(new RuntimeException("test"));
    // assertEquals("Unexpected exception cause", RuntimeException.class,
