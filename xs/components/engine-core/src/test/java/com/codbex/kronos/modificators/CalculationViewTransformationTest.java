...
public class CalculationViewTransformationTest {
    ...
    // byte[] sourceXML =
    // getByteArrayFromResourceName("/META-INF/modificators/files-to-modify/testCalculationView.calculationview");
    // byte[] expectedXML =
    // getByteArrayFromResourceName("/META-INF/modificators/expected-results/testCalculationView.calculationview");
