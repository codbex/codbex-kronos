...
public class HDBProcedureProcessorTest {
    ...
    // configuration.when(() ->
    // Configuration.get(DatabaseMetadataUtil.DIRIGIBLE_DATABASE_NAMES_CASE_SENSITIVE,
    // "false")).thenReturn("true");
    //
    // HDBProcedureCreateProcessor processorSpy = spy(HDBProcedureCreateProcessor.class);
    // String hdbProcedureSample =
    // IOUtils.toString(ProcedureProcessorTest.class.getResourceAsStream("/OrderProcedure.hdbprocedure"),
