...
public class HDBSequenceDataStructureParser implements HDBDataStructureParser<HDBSequence> {
     ...
     */
    @Override
    public HDBSequence parse(HDBParameters parametersModel) throws DataStructuresException, IOException, ArtifactParserException {
     ...
     * @throws ArtifactParserException the artifact parser exception
     */
    private HDBSequence parseHanaXSClassicContent(String location, String content) throws IOException, ArtifactParserException {
        ...
        com.codbex.kronos.parser.hdbsequence.core.HDBSequenceParser hdbSequenceParser =
                new com.codbex.kronos.parser.hdbsequence.core.HDBSequenceParser((tokenStream));
        ...
        Gson gson = new GsonBuilder().registerTypeAdapter(HDBSequenceModel.class, new HDBSequenceModelAdapter())
                                     .create();
        ...
        HDBUtils.populateDataStructureModel(location, content, hdbSequenceModel, IDataStructureModel.TYPE_HDB_SEQUENCE, true);
