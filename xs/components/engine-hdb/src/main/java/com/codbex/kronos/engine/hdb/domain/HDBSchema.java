...
public class HDBSchema extends HDBDataStructure {
     ...
     */
    protected HDBSchema(String location, String name, String description, String dependencies, String schema, String content,
            boolean classic) {
    ...
    public String toString() {
        return "HDBSchema [id=" + id + ", location=" + location + ", name=" + name + ", type=" + type + ", description=" + description
