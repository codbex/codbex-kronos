...
public class HDBDataStructureModelFactory implements InitializingBean {
     ...
     * @throws IOException Signals that an I/O exception has occurred.
     */
    public static HDBTable parseTable(String location, byte[] bytes) throws DataStructuresException, ArtifactParserException, IOException {
     ...
     * @throws IOException Signals that an I/O exception has occurred.
     */
    public static HDBView parseView(String location, String content) throws DataStructuresException, ArtifactParserException, IOException {
        HDBParameters parametersModel = new HDBParameters(null, location, content, null);
     ...
     * @throws IOException Signals that an I/O exception has occurred.
     */
    public static HDBView parseView(String location, byte[] bytes) throws DataStructuresException, ArtifactParserException, IOException {
     ...
     * @throws IOException Signals that an I/O exception has occurred.
     */
    public static HDBSynonymGroup parseSynonym(String location, String content) throws DataStructuresException, IOException {
        HDBParameters parametersModel = new HDBParameters(null, location, content, null);
     ...
     * @throws IOException Signals that an I/O exception has occurred.
     */
    public static HDBSynonymGroup parseSynonym(String location, byte[] bytes) throws DataStructuresException, IOException {
