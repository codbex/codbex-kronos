...
public class HDBProcedureDataStructureParser implements HDBDataStructureParser<HDBProcedure> {
     ...
     */
    @Override
    public HDBProcedure parse(HDBParameters parametersModel) throws DataStructuresException, ArtifactParserException {
    ...
    public void logError(String parsedFileLocation, String problemsFacadeMessage, String exceptionMessage) {
        CommonsUtils.logCustomErrors(parsedFileLocation, CommonsConstants.PARSER_ERROR, "", // line
                "", // column
                exceptionMessage, problemsFacadeMessage, CommonsConstants.HDB_PROCEDURE_PARSER, CommonsConstants.MODULE_PARSERS,
