...
public class HDBDataStructureDataStructureParser implements HDBDataStructureParser<HDBTableStructure> {
     ...
     */
    @Override
    public HDBTableStructure parse(HDBParameters parametersModel) throws DataStructuresException, IOException, ArtifactParserException {
        ...
        HDBUtils.populateDataStructureModel(parametersModel.getLocation(), parametersModel.getContent(), hdbStructureModel,
                IDataStructureModel.TYPE_HDB_STRUCTURE, true);
                               ...
                               .forEach(key -> {
                                   ...
                                   if (foundMatchKey.size() != 1) {
                                       ...
                                       CommonsUtils.logCustomErrors(parametersModel.getLocation(), CommonsConstants.PARSER_ERROR, "", "",
                                               errMsg, "", CommonsConstants.HDB_STRUCTURE_PARSER, CommonsConstants.MODULE_PARSERS,
                                               CommonsConstants.SOURCE_PUBLISH_REQUEST, CommonsConstants.PROGRAM_KRONOS);
