...
public class HDBColumn {
     ...
     */
    public HDBColumn(String name, String type, String length, boolean nullable, boolean primaryKey, String defaultValue, String scale,
            boolean unique) {
        super();
        this.name = name;
        this.type = type;
     ...
     *
     * @param isDefaultValueDateTimeFunction the new default value date time function
     */
    ...
    public String toString() {
        return "HDBColumn [name=" + name + ", type=" + type + ", length=" + length + ", nullable=" + nullable + ", primaryKey=" + primaryKey
                + ", defaultValue=" + defaultValue + ", scale=" + scale + ", unique=" + unique + "]";
    }
