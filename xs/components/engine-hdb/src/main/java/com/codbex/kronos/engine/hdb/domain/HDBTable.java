...
public class HDBTable extends HDBDataStructure {
    ...
    /**
     * Sets the checks if is temporary.
     *
     * @param isTemporary the new checks if is temporary
     */
     ...
     */
    public HDBTableColumn addColumn(String name, String type, String length, boolean nullable, boolean primaryKey, String defaultValue,
    ...
    public String toString() {
        return "HDBTable [id=" + id + ", tableType=" + tableType + ", columns=" + columns + ", indexes=" + indexes + ", constraints="
                + constraints + ", isPublic=" + isPublic + ", loggingType=" + loggingType + ", temporary=" + isTemporary + ", hdbdd="
                + hdbdd + ", location=" + location + ", name=" + name + ", type=" + type + ", description=" + description + ", key=" + key
