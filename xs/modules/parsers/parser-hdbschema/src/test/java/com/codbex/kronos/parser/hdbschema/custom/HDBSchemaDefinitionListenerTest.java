...
public class HDBSchemaDefinitionListenerTest {
    ...
    public void testParseHDBSchemaFileWithoutErrorsSuccessfully() throws Exception {
        String hdbSchemaSample = org.apache.commons.io.IOUtils.toString(
                HDBSchemaDefinitionListenerTest.class.getResourceAsStream("/sample.hdbschema"), StandardCharsets.UTF_8);
    ...
    public void testParseHDBSchemaFileWithSyntaxErrorExceptionThrown() throws Exception {
        String hdbSchemaSample = org.apache.commons.io.IOUtils.toString(
                HDBSchemaDefinitionListenerTest.class.getResourceAsStream("/sample_with_errors.hdbschema"), StandardCharsets.UTF_8);
