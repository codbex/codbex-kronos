...
/**
 * The listener interface for receiving HDBSequenceSyntaxError events. The class that is interested
 * in processing a HDBSequenceSyntaxError event implements this interface, and the object created
 * with that class is registered with a component using the component's
 * <code>addHDBSequenceSyntaxErrorListener</code> method. When the HDBSequenceSyntaxError event
