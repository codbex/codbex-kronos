...
public class HDBTIDefinitionListenerTest {
    ...
    public void testParseHDBHDBTIFileWithoutErrorsSuccessfully() throws Exception {
        String hdbSchemaSample = org.apache.commons.io.IOUtils.toString(
                HDBTIDefinitionListenerTest.class.getResourceAsStream("/sample.hdbti"), StandardCharsets.UTF_8);
    ...
    public void testParseHDBTIFileWithSyntaxErrorExceptionThrown() throws Exception {
        String hdbSchemaSample = org.apache.commons.io.IOUtils.toString(
                HDBTIDefinitionListenerTest.class.getResourceAsStream("/sample_with_errors.hdbti"), StandardCharsets.UTF_8);
