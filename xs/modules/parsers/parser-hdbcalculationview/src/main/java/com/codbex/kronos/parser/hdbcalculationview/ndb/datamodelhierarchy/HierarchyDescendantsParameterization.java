...
/**
 * Returns all descendants of a set of start nodes in a hierarchy. Docs:
 * https://help.sap.com/viewer/4fe29514fd584807ac9f2a04f6754767/2.0.02/en-US/589208b0582245a782a1f3667a5b80c1.html
 *
 *
...
@XmlType(name = "HierarchyDescendantsParameterization",
        propOrder = {"start", "startWhere", "distance", "distanceParameter", "distanceFrom", "distanceFromParameter", "distanceTo",
                "distanceToParameter"})
@XmlSeeAlso({HierarchyAncestorsParameterization.class})
