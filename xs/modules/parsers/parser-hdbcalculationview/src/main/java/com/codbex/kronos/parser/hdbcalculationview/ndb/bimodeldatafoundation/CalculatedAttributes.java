...
@XmlType(name = "CalculatedAttributes", propOrder = {"calculatedAttribute"})
public class CalculatedAttributes {
     ...
     * will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the calculatedAttribute property.
     *
     *
     ...
     *
     *
     * Objects of the following type(s) are allowed in the list {@link CalculatedAttribute }
     *
