...
@XmlType(name = "Columns", propOrder = {"columnName"})
public class Columns {
     ...
     * will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the columnName property.
     *
     *
