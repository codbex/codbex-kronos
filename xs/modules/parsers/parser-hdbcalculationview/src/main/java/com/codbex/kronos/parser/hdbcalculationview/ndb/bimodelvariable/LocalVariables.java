...
@XmlType(name = "LocalVariables", propOrder = {"variable"})
public class LocalVariables {
     ...
     * will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the variable property.
     *
     *
     ...
     *
     *
     * Objects of the following type(s) are allowed in the list {@link LocalVariable }
     *
     * @return the variable
     */
