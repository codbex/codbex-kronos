...
@XmlType(name = "CalculationViews", propOrder = {"calculationView"})
public class CalculationViews {
     ...
     * will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the calculationView property.
     *
     *
     ...
     *
     *
     * Objects of the following type(s) are allowed in the list {@link CalculationView }
     *
