 ...
 *       &lt;sequence&gt;
 *         &lt;element name="localDimension" type="{http://www.sap.com/ndb/BiModelDimension.ecore}LocalDimension" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "LocalDimensions", propOrder = {"localDimension"})
public class LocalDimensions {
     ...
     *
     *
     * Objects of the following type(s) are allowed in the list {@link LocalDimension }
     *
     * @return the local dimension
     */
    public List<LocalDimension> getLocalDimension() {
        if (localDimension == null) {
            localDimension = new ArrayList<LocalDimension>();
        }
