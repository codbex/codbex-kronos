...
@XmlType(name = "TableProxies", propOrder = {"tableProxy"})
public class TableProxies {
     ...
     * will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the tableProxy property.
     *
     *
     ...
     *
     *
     * Objects of the following type(s) are allowed in the list {@link TableProxy }
     *
