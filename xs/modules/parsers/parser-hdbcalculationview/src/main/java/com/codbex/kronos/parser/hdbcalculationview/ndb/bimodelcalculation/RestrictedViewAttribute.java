...
/**
 * Java class for RestrictedViewAttribute complex type.
 *
...
@XmlType(name = "RestrictedViewAttribute", propOrder = {"restriction", "restrictionExpression"})
public class RestrictedViewAttribute extends ViewAttribute {
