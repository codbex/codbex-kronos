...
@XmlType(name = "Measure", propOrder = {"currencyConversion", "unitConversion", "conversionReference", "exceptionAggregation"})
@XmlSeeAlso({BaseMeasure.class, CalculatedMeasure.class, RestrictedMeasure.class})
public class Measure extends LogicalColumn {
     ...
     *
     *
     * Objects of the following type(s) are allowed in the list {@link MeasureDimensionality }
     *
