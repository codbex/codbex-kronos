...
@XmlType(name = "GetShortestPathsParameterization",
        propOrder = {"startVertex", "startVertexParameter", "inputWeightColumn", "inputWeightColumnParameter", "direction",
                "directionParameter"})
@XmlSeeAlso({GetShortestPathParameterization.class})
public class GetShortestPathsParameterization extends GraphActionParameterization {
     ...
     *
     * @param value allowed object is {@link Direction }
     */
