...
@XmlType(name = "AnonymizeParameterization",
        propOrder = {"seqColumn", "k", "loss", "qidColumn", "qidColumnHierarchy", "epsilon", "sensitivity", "noisedColumn"})
public class AnonymizeParameterization {
     ...
     *
     *
     * Objects of the following type(s) are allowed in the list {@link QidColumn }
     *
     ...
     *
     *
     * Objects of the following type(s) are allowed in the list {@link QidColumnHierarchy }
     *
