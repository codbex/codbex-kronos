...
@XmlType(name = "LogicalColumn",
        propOrder = {"unitCurrencyAttribute", "fixedCurrency", "fixedUnit", "externalLikeStructureName", "externalLikeElementName",
                "variableMapping", "internalExternalConversion", "maskingExpression"})
@XmlSeeAlso({AbstractAttribute.class, Measure.class})
public abstract class LogicalColumn extends IDObjectWithDescription {
     ...
     *
     * @return possible object is {@link SemanticType }
     */
     ...
     *
     * @param value allowed object is {@link SemanticType }
     */
