...
@XmlType(name = "Element",
        propOrder = {"calculationDefinition", "unitCurrencyElement", "fixedCurrency", "fixedUnit", "currencyConversion", "unitConversion",
                "labelElement", "quickInfoElement", "elementRelationship", "restriction", "restrictionExpression",
                "exceptionAggregationStep", "searchProperties", "genericProperty", "runtime"})
public class Element extends TypedObject {
     ...
     *
     *
     * Objects of the following type(s) are allowed in the list {@link ElementRelationship }
     *
     ...
     *
     *
     * Objects of the following type(s) are allowed in the list {@link ElementRefFilter }
     *
     ...
     *
     *
     * Objects of the following type(s) are allowed in the list {@link ExceptionAggregationStep }
     *
