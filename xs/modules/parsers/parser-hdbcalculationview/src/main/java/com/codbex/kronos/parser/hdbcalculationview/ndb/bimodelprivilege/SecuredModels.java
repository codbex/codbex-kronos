...
@XmlType(name = "SecuredModels", propOrder = {"modelUri"})
public class SecuredModels {
     ...
     * will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the modelUri property.
     *
     *
