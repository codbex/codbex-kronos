...
@XmlType(name = "Shape", propOrder = {"upperLeftCorner", "rectangleSize"})
@XmlSeeAlso({RectangularShape.class})
public class Shape {
     ...
     *
     * @return possible object is {@link ModelObjectType }
     */
     ...
     *
     * @param value allowed object is {@link ModelObjectType }
     */
