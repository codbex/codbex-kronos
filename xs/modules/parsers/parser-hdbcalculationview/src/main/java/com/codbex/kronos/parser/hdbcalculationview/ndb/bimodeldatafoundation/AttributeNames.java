...
@XmlType(name = "AttributeNames", propOrder = {"attributeName"})
public class AttributeNames {
     ...
     * will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the attributeName property.
     *
     *
