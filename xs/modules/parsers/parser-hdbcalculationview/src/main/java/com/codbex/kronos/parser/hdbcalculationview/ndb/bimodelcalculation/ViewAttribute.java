...
import com.codbex.kronos.parser.hdbcalculationview.ndb.bimodelcube.AggregationType;
...
@XmlType(name = "ViewAttribute", propOrder = {"filter", "currencyConversion", "unitConversion", "conversionReference"})
@XmlSeeAlso({CalculatedViewAttribute.class, RestrictedViewAttribute.class})
