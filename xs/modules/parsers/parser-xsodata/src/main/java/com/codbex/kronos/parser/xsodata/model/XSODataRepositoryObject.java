...
public class XSODataRepositoryObject {
    ...
    /**
     * Catalog object name The name can represent repoobject or catalogobject. Repoobject is represented
     * as "repopackage '/' reponame '.' repoextension" *
     *
     * <pre>{@code
     *      service {
     ...
     */
    public XSODataRepositoryObject setCatalogObjectName(String catalogObjectName) {
     ...
     * @return the HDBXSO data repository object
     */
    public XSODataRepositoryObject setCatalogObjectSchema(String catalogObjectSchema) {
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || getClass() != o.getClass())
            return false;
        XSODataRepositoryObject that = (XSODataRepositoryObject) o;
