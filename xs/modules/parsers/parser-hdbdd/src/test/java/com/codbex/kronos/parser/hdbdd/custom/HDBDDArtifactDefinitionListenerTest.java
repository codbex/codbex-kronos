...
public class HDBDDArtifactDefinitionListenerTest {
    ...
    public void testParseEntitySuccessfully() throws Exception {
        ...
        assertEquals("TEST_SCHEMA", parsedEntities.get(0)
                                                  .getSchema());
    }
    ...
    public void testParseAssociationsSuccessfully() throws Exception {
        ...
        assertEquals(0, parsedFile.getNumberOfSyntaxErrors());
        assertEquals(0, parsedEntities.get(1)
                                      .getAssociations()
                                      .get(0)
                                      .getForeignKeys()
                                      .size());
        assertEquals(1, parsedEntities.get(1)
                                      .getAssociations()
                                      .get(1)
                                      .getForeignKeys()
                                      .size());
    ...
    public void testParseAssociationsWithKeyAndNullConstraint() throws Exception {
        CdsParser parsedFile =
                parseSampleFile("/AssociationWithKeyAndNullConstraint.hdbdd", "sap/db/AssociationWithKeyAndNullConstraint.hdbdd");
        assertEquals(0, parsedFile.getNumberOfSyntaxErrors());
    }
    ...
    public void testParseAssociationElementNotPKForUnmanagedForeignKey() throws Exception {
        try {
            parseSampleFile("/AssociationElementNotPKForUnmanagedForeignKey.hdbdd",
                    "sap/db/AssociationElementNotPKForUnmanagedForeignKey.hdbdd");
        } catch (RuntimeException e) {
            assertEquals(CDSRuntimeException.class, e.getClass());
            assertEquals(
    ...
    public void testParseElementNameAsEntityName() throws Exception {
        ...
        assertEquals(0, parsedFile.getNumberOfSyntaxErrors());
        assertEquals(parsedEntities.get(0)
                                   .getName(),
                parsedEntities.get(0)
                              .getElements()
                              .get(0)
                              .getName());
    }
    ...
    public void testParseNoKeyAnnotationForEntityWithoutKeys() throws Exception {
        CdsParser parsedFile =
                parseSampleFile("/NoKeyAnnotationForEntityWithoutKeys.hdbdd", "sap/db/NoKeyAnnotationForEntityWithoutKeys.hdbdd");
        List<EntitySymbol> parsedEntities = this.symbolTable.getSortedEntities();
        assertEquals(0, parsedFile.getNumberOfSyntaxErrors());
        assertEquals(1, parsedEntities.size());
    }
    ...
    public void testParseHanaBuiltInTypesSuccessfully() throws Exception {
        ...
        assertEquals(10, entity.getElements()
                               .size());

        assertEquals("hana.ALPHANUM", entity.getElements()
                                            .get(1)
                                            .getType()
                                            .getName());
        assertEquals("hana.VARCHAR", entity.getElements()
                                           .get(0)
                                           .getType()
                                           .getName());
        assertEquals("hana.SMALLINT", entity.getElements()
                                            .get(2)
                                            .getType()
                                            .getName());
        assertEquals("hana.TINYINT", entity.getElements()
                                           .get(3)
                                           .getType()
                                           .getName());
        assertEquals("hana.REAL", entity.getElements()
                                        .get(4)
                                        .getType()
                                        .getName());
        assertEquals("hana.SMALLDECIMAL", entity.getElements()
                                                .get(5)
                                                .getType()
                                                .getName());
        assertEquals("hana.CLOB", entity.getElements()
                                        .get(6)
                                        .getType()
                                        .getName());
        assertEquals("hana.BINARY", entity.getElements()
                                          .get(7)
                                          .getType()
                                          .getName());
        assertEquals("hana.ST_POINT", entity.getElements()
                                            .get(8)
                                            .getType()
                                            .getName());
        assertEquals("hana.ST_GEOMETRY", entity.getElements()
                                               .get(9)
                                               .getType()
                                               .getName());
    }
    ...
    public void testParseHanaToCDSTypesSuccessfully() throws Exception {
        ...
        EntitySymbol entity = parsedEntities.get(0);
        assertEquals(6, entity.getElements()
                              .size());

        assertEquals("Integer", entity.getElements()
                                      .get(0)
                                      .getType()
                                      .getName());
        assertEquals("String", entity.getElements()
                                     .get(1)
                                     .getType()
                                     .getName());
        assertEquals("hana.VARCHAR", entity.getElements()
                                           ...
                                           .getType()
                                           .getName());
        assertEquals("BinaryFloat", entity.getElements()
                                          .get(3)
                                          .getType()
                                          .getName());
        assertEquals("BinaryFloat", entity.getElements()
                                          ...
                                          .getType()
                                          .getName());
        assertEquals("UTCTimestamp", entity.getElements()
                                           .get(5)
                                           .getType()
                                           .getName());
    }
    ...
    public void testParseGlobalBuiltInTypesSuccessfully() throws Exception {
        ...
        assertEquals(1, parsedEntities.size());
        EntitySymbol entity = parsedEntities.get(0);
        assertEquals(16, entity.getElements()
                               .size());
        ...
        assertEquals("String", entity.getElements()
                                     ...
                                     .getType()
                                     .getName());
        assertEquals("LargeString", entity.getElements()
                                          .get(1)
                                          .getType()
                                          .getName());
        assertEquals("String", entity.getElements()
                                     ...
                                     .getType()
                                     .getName());
        assertEquals("Binary", entity.getElements()
                                     .get(3)
                                     .getType()
                                     .getName());
        assertEquals("LargeBinary", entity.getElements()
                                          .get(4)
                                          .getType()
                                          .getName());
        assertEquals("Integer", entity.getElements()
                                      ...
                                      .getType()
                                      .getName());
        assertEquals("Integer64", entity.getElements()
                                        .get(6)
                                        .getType()
                                        .getName());
        assertEquals("Decimal", entity.getElements()
                                      .get(7)
                                      .getType()
                                      .getName());
        assertEquals("DecimalFloat", entity.getElements()
                                           .get(8)
                                           .getType()
                                           .getName());
        assertEquals("BinaryFloat", entity.getElements()
        ...
        assertEquals("Decimal", entity.getElements()
                                      ...
                                      .getType()
                                      .getName());
        assertEquals("LocalDate", entity.getElements()
                                        .get(11)
                                        .getType()
                                        .getName());
        assertEquals("LocalTime", entity.getElements()
                                        .get(12)
                                        .getType()
                                        .getName());
        assertEquals("UTCDateTime", entity.getElements()
                                          .get(13)
                                          .getType()
                                          .getName());
        assertEquals("UTCTimestamp", entity.getElements()
                                           ...
                                           .getType()
                                           .getName());
        assertEquals("Boolean", entity.getElements()
                                      .get(15)
                                      .getType()
                                      .getName());
    }
    ...
    public void testParseArtifactsNamedAsKeywordsSuccessfully() throws Exception {
        ...
        assertEquals(4, this.symbolTable.getSymbolsByFullName()
                                        .size());
        ...
        assertNotNull(this.symbolTable.getSymbolsByFullName()
                                      .get("sap.db::Context.Type"));
        Symbol resolvedType = this.symbolTable.getSymbolsByFullName()
                                              .get("sap.db::Context.Type");
    ...
    public void testParseInvalidBuiltInHanaType() throws Exception {
        try {
            ...
            assertEquals(CDSRuntimeException.class, e.getClass());
            assertEquals(
                    "Failed to parse file: sap/db/InvalidBuiltInHanaType.hdbdd. Error at line: 7. No such user defined type found: hana",
                    e.getMessage());
        }
    }
    ...
    public void testParseInvalidBuiltInHanaTypeWithArgs() throws Exception {
        try {
            ...
            assertEquals(CDSRuntimeException.class, e.getClass());
            assertEquals(
                    "Failed to parse file: sap/db/InvalidBuiltInHanaTypeWithArgs.hdbdd. Error at line: 7. No such user defined type found: hana",
                    e.getMessage());
        }
    }
    ...
    public void testParseInvalidBuiltInType() throws Exception {
        try {
            ...
            assertEquals(CDSRuntimeException.class, e.getClass());
            assertEquals(
                    "Failed to parse file: sap/db/InvalidBuiltInType.hdbdd. Error at line: 7. No such user defined type found: LongText",
                    e.getMessage());
        }
    }
    ...
    public void testParseCircularDependency() throws Exception {
        try {
            ...
            assertEquals(CDSRuntimeException.class, e.getClass());
            assertEquals("Failed to parse file: sap/db/CircularDependency.hdbdd. Circular dependency", e.getMessage());
        }
    }
    ...
    public void testParseNonExistingUserDefinedType() throws Exception {
        try {
            ...
            assertEquals(CDSRuntimeException.class, e.getClass());
            assertEquals(
                    "Failed to parse file: sap/db/NonExistingUserDefinedType.hdbdd. Error at line: 9. No such user defined type found: MyCustomType",
                    e.getMessage());
        }
    }
    ...
    private CdsParser parseSampleFile(String sampleFileName, String location) throws Exception {
        String content = org.apache.commons.io.IOUtils.toString(HDBDDArtifactDefinitionListener.class.getResourceAsStream(sampleFileName),
        ...
        HDBDDArtifactDefinitionListener hdbddArtifactDefinitionListener = new HDBDDArtifactDefinitionListener();
        hdbddArtifactDefinitionListener.setSymbolTable(symbolTable);
        hdbddArtifactDefinitionListener.setFileLocation(location);

        ParseTreeWalker parseTreeWalker = new ParseTreeWalker();
        parseTreeWalker.walk(hdbddArtifactDefinitionListener, parseTree);

        HDBDDReferenceResolvingListener hdbddReferenceResolvingListener = new HDBDDReferenceResolvingListener();
        hdbddReferenceResolvingListener.setSymbolTable(symbolTable);
        hdbddReferenceResolvingListener.setEntityElements(hdbddArtifactDefinitionListener.getEntityElements());
        hdbddReferenceResolvingListener.setTypeables(hdbddArtifactDefinitionListener.getTypeables());
        hdbddReferenceResolvingListener.setAssociations(hdbddArtifactDefinitionListener.getAssociations());

        try {
            parseTreeWalker.walk(hdbddReferenceResolvingListener, parseTree);
