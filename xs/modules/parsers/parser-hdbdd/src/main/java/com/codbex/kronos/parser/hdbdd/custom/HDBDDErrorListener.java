...
/**
 * The listener interface for receiving HDBDDError events. The class that is interested in
 * processing a HDBDDError event implements this interface, and the object created with that class
 * is registered with a component using the component's <code>addHDBDDErrorListener</code> method.
 * When the HDBDDError event occurs, that object's appropriate method is invoked.
 *
 */
