...
public class SymbolTable {
    ...
    protected void initTypeSystem() {
        ...
        cdsTypeScope.define(
                new BuiltInTypeSymbol("UTCDateTime", 0, Arrays.asList(CdsLexer.UTC_DATE_TIME, CdsLexer.DATETIME_VALUE_FUNCTION)));
        cdsTypeScope.define(
                new BuiltInTypeSymbol(UTC_TIMESTAMP, 0, Arrays.asList(CdsLexer.UTC_TIMESTAMP, CdsLexer.DATETIME_VALUE_FUNCTION)));
    ...
    public void addChildToEntity(String entityName, String childName) {
        ...
        this.entityGraph.get(entityName)
                        .add(childName);
    }
    ...
    public List<EntitySymbol> getSortedEntities() {
        ...
        entityGraph.keySet()
                   .forEach(entityName -> traverseEntityGraph(entityName, orderedEntities, passedEntities));
    ...
    public List<ViewSymbol> getSortedViews() {
        ...
        viewGraph.keySet()
                 .forEach(viewName -> traverseViewGraph(viewName, orderedViews, passedViews));
    ...
    public List<StructuredDataTypeSymbol> getTableTypes() {
        return this.symbolsByFullName.values()
                                     .stream()
                                     .filter(StructuredDataTypeSymbol.class::isInstance)
