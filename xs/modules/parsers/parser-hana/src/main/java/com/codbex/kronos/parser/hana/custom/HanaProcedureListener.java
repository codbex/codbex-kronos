...
/**
 * The listener interface for receiving hanaProcedure events. The class that is interested in
 * processing a hanaProcedure event implements this interface, and the object created with that
 * class is registered with a component using the component's <code>addHanaProcedureListener</code>
 * method. When the hanaProcedure event occurs, that object's appropriate method is invoked.
 *
 */
